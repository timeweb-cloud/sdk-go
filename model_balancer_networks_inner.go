...
// checks if the BalancerNetworksInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BalancerNetworksInner{}

// BalancerNetworksInner struct for BalancerNetworksInner
type BalancerNetworksInner struct {
	...
	Ips []BalancerNetworksInnerIpsInner `json:"ips"`
}
...
// If the value is explicit nil, the zero value for []BalancerNetworksInnerIpsInner will be returned
func (o *BalancerNetworksInner) GetIps() []BalancerNetworksInnerIpsInner {
	if o == nil {
		var ret []BalancerNetworksInnerIpsInner
		return ret
	}
...
func (o BalancerNetworksInner) MarshalJSON() ([]byte, error) {
...
func (o BalancerNetworksInner) ToMap() (map[string]interface{}, error) {
...
type NullableBalancerNetworksInner struct {
	value *BalancerNetworksInner
	isSet bool
}

func (v NullableBalancerNetworksInner) Get() *BalancerNetworksInner {
	return v.value
}

func (v *NullableBalancerNetworksInner) Set(val *BalancerNetworksInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBalancerNetworksInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBalancerNetworksInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBalancerNetworksInner(val *BalancerNetworksInner) *NullableBalancerNetworksInner {
	return &NullableBalancerNetworksInner{value: val, isSet: true}
}

func (v NullableBalancerNetworksInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBalancerNetworksInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
