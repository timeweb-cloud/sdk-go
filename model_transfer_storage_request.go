...
// checks if the TransferStorageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransferStorageRequest{}

// TransferStorageRequest struct for TransferStorageRequest
...
// GetIsForcePathStyle returns the IsForcePathStyle field value
func (o *TransferStorageRequest) GetIsForcePathStyle() bool {
	...
	return o.IsForcePathStyle
}

// GetIsForcePathStyleOk returns a tuple with the IsForcePathStyle field value
// and a boolean to check if the value has been set.
func (o *TransferStorageRequest) GetIsForcePathStyleOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsForcePathStyle, true
}

// SetIsForcePathStyle sets field value
func (o *TransferStorageRequest) SetIsForcePathStyle(v bool) {
	o.IsForcePathStyle = v
}
...
// GetNewBucketName returns the NewBucketName field value
func (o *TransferStorageRequest) GetNewBucketName() string {
	...
	return o.NewBucketName
}

// GetNewBucketNameOk returns a tuple with the NewBucketName field value
// and a boolean to check if the value has been set.
func (o *TransferStorageRequest) GetNewBucketNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NewBucketName, true
}

// SetNewBucketName sets field value
func (o *TransferStorageRequest) SetNewBucketName(v string) {
	o.NewBucketName = v
}

func (o TransferStorageRequest) MarshalJSON() ([]byte, error) {
...
func (o TransferStorageRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["access_key"] = o.AccessKey
	toSerialize["secret_key"] = o.SecretKey
	toSerialize["location"] = o.Location
	toSerialize["is_force_path_style"] = o.IsForcePathStyle
	toSerialize["endpoint"] = o.Endpoint
	toSerialize["bucket_name"] = o.BucketName
	toSerialize["new_bucket_name"] = o.NewBucketName
	return toSerialize, nil
}

type NullableTransferStorageRequest struct {
	value *TransferStorageRequest
	isSet bool
}

func (v NullableTransferStorageRequest) Get() *TransferStorageRequest {
	return v.value
}

func (v *NullableTransferStorageRequest) Set(val *TransferStorageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTransferStorageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTransferStorageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransferStorageRequest(val *TransferStorageRequest) *NullableTransferStorageRequest {
	return &NullableTransferStorageRequest{value: val, isSet: true}
}

func (v NullableTransferStorageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransferStorageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
