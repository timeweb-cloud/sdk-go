...
// checks if the UpdateNotificationSettingsRequestSettingsInnerChannels type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNotificationSettingsRequestSettingsInnerChannels{}

// UpdateNotificationSettingsRequestSettingsInnerChannels Название канала уведомлений.
type UpdateNotificationSettingsRequestSettingsInnerChannels struct {
	Telegram *SettingCondition `json:"telegram,omitempty"`
	Sms *SettingCondition `json:"sms,omitempty"`
	Email *SettingCondition `json:"email,omitempty"`
}
...
func NewUpdateNotificationSettingsRequestSettingsInnerChannels() *UpdateNotificationSettingsRequestSettingsInnerChannels {
	this := UpdateNotificationSettingsRequestSettingsInnerChannels{}
	return &this
}
...
// SetTelegram gets a reference to the given SettingCondition and assigns it to the Telegram field.
...
// SetSms gets a reference to the given SettingCondition and assigns it to the Sms field.
...
// SetEmail gets a reference to the given SettingCondition and assigns it to the Email field.
func (o *UpdateNotificationSettingsRequestSettingsInnerChannels) SetEmail(v SettingCondition) {
	o.Email = &v
}

func (o UpdateNotificationSettingsRequestSettingsInnerChannels) MarshalJSON() ([]byte, error) {
...
func (o UpdateNotificationSettingsRequestSettingsInnerChannels) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNotificationSettingsRequestSettingsInnerChannels struct {
	value *UpdateNotificationSettingsRequestSettingsInnerChannels
	isSet bool
}

func (v NullableUpdateNotificationSettingsRequestSettingsInnerChannels) Get() *UpdateNotificationSettingsRequestSettingsInnerChannels {
	return v.value
}

func (v *NullableUpdateNotificationSettingsRequestSettingsInnerChannels) Set(val *UpdateNotificationSettingsRequestSettingsInnerChannels) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNotificationSettingsRequestSettingsInnerChannels) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNotificationSettingsRequestSettingsInnerChannels) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNotificationSettingsRequestSettingsInnerChannels(val *UpdateNotificationSettingsRequestSettingsInnerChannels) *NullableUpdateNotificationSettingsRequestSettingsInnerChannels {
	return &NullableUpdateNotificationSettingsRequestSettingsInnerChannels{value: val, isSet: true}
}

func (v NullableUpdateNotificationSettingsRequestSettingsInnerChannels) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNotificationSettingsRequestSettingsInnerChannels) UnmarshalJSON(src []byte) error {
	v.isSet = true
