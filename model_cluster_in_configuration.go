...
// checks if the ClusterInConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterInConfiguration{}

// ClusterInConfiguration Параметры конфигурации мастер-ноды. Нельзя передавать вместе с `preset_id`.
type ClusterInConfiguration struct {
...
func (o ClusterInConfiguration) MarshalJSON() ([]byte, error) {
...
func (o ClusterInConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableClusterInConfiguration struct {
	value *ClusterInConfiguration
	isSet bool
}

func (v NullableClusterInConfiguration) Get() *ClusterInConfiguration {
	return v.value
}

func (v *NullableClusterInConfiguration) Set(val *ClusterInConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterInConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterInConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterInConfiguration(val *ClusterInConfiguration) *NullableClusterInConfiguration {
	return &NullableClusterInConfiguration{value: val, isSet: true}
}

func (v NullableClusterInConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterInConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
