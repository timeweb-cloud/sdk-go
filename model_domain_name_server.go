...
type DomainNameServer struct {
	...
	IsDelegationAllowed bool `json:"is_delegation_allowed"`
	// Список name-серверов
	Items []DomainNameServerItemsInner `json:"items"`
...
// GetIsDelegationAllowed returns the IsDelegationAllowed field value
func (o *DomainNameServer) GetIsDelegationAllowed() bool {
	...
	return o.IsDelegationAllowed
}

// GetIsDelegationAllowedOk returns a tuple with the IsDelegationAllowed field value
// and a boolean to check if the value has been set.
func (o *DomainNameServer) GetIsDelegationAllowedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsDelegationAllowed, true
}

// SetIsDelegationAllowed sets field value
func (o *DomainNameServer) SetIsDelegationAllowed(v bool) {
	o.IsDelegationAllowed = v
}

// GetItems returns the Items field value
func (o *DomainNameServer) GetItems() []DomainNameServerItemsInner {
	if o == nil {
		var ret []DomainNameServerItemsInner
		return ret
	}
...
func (o DomainNameServer) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["is_delegation_allowed"] = o.IsDelegationAllowed
