...
// checks if the AutoReplyIsEnabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoReplyIsEnabled{}

// AutoReplyIsEnabled struct for AutoReplyIsEnabled
type AutoReplyIsEnabled struct {
...
func (o AutoReplyIsEnabled) MarshalJSON() ([]byte, error) {
...
func (o AutoReplyIsEnabled) ToMap() (map[string]interface{}, error) {
...
type NullableAutoReplyIsEnabled struct {
	value *AutoReplyIsEnabled
	isSet bool
}

func (v NullableAutoReplyIsEnabled) Get() *AutoReplyIsEnabled {
	return v.value
}

func (v *NullableAutoReplyIsEnabled) Set(val *AutoReplyIsEnabled) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoReplyIsEnabled) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoReplyIsEnabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoReplyIsEnabled(val *AutoReplyIsEnabled) *NullableAutoReplyIsEnabled {
	return &NullableAutoReplyIsEnabled{value: val, isSet: true}
}

func (v NullableAutoReplyIsEnabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoReplyIsEnabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
