...
// checks if the CreateDns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDns{}

// CreateDns struct for CreateDns
...
func (o CreateDns) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDns struct {
	value *CreateDns
	isSet bool
}

func (v NullableCreateDns) Get() *CreateDns {
	return v.value
}

func (v *NullableCreateDns) Set(val *CreateDns) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDns) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDns(val *CreateDns) *NullableCreateDns {
	return &NullableCreateDns{value: val, isSet: true}
}

func (v NullableCreateDns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDns) UnmarshalJSON(src []byte) error {
	v.isSet = true
