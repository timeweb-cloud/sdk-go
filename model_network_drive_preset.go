...
// checks if the NetworkDrivePreset type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDrivePreset{}

// NetworkDrivePreset struct for NetworkDrivePreset
type NetworkDrivePreset struct {
	// ID тарифа.
	Id float32 `json:"id"`
	// Стоимость тарифа сетевого диска.
	CostPerGb float32 `json:"cost_per_gb"`
	...
	Read NetworkDrivePresetRead `json:"read"`
	Write NetworkDrivePresetWrite `json:"write"`
}
...
// GetCostPerGb returns the CostPerGb field value
...
// GetCostPerGbOk returns a tuple with the CostPerGb field value
// and a boolean to check if the value has been set.
...
func (o *NetworkDrivePreset) GetRead() NetworkDrivePresetRead {
	if o == nil {
		var ret NetworkDrivePresetRead
		return ret
	}
...
func (o *NetworkDrivePreset) GetWrite() NetworkDrivePresetWrite {
	if o == nil {
		var ret NetworkDrivePresetWrite
		return ret
	}
...
func (o NetworkDrivePreset) MarshalJSON() ([]byte, error) {
...
func (o NetworkDrivePreset) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkDrivePreset struct {
	value *NetworkDrivePreset
	isSet bool
}

func (v NullableNetworkDrivePreset) Get() *NetworkDrivePreset {
	return v.value
}

func (v *NullableNetworkDrivePreset) Set(val *NetworkDrivePreset) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDrivePreset) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDrivePreset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDrivePreset(val *NetworkDrivePreset) *NullableNetworkDrivePreset {
	return &NullableNetworkDrivePreset{value: val, isSet: true}
}

func (v NullableNetworkDrivePreset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDrivePreset) UnmarshalJSON(src []byte) error {
	v.isSet = true
