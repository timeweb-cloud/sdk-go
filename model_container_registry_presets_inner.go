...
// checks if the ContainerRegistryPresetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContainerRegistryPresetsInner{}

// ContainerRegistryPresetsInner struct for ContainerRegistryPresetsInner
type ContainerRegistryPresetsInner struct {
	// ID тарифа
	Id int32 `json:"id"`
	// Описание тарифа
...
func NewContainerRegistryPresetsInner(id int32, description string, descriptionShort string, disk int32, price float32) *ContainerRegistryPresetsInner {
	this := ContainerRegistryPresetsInner{}
	this.Id = id
...
func (o ContainerRegistryPresetsInner) MarshalJSON() ([]byte, error) {
...
func (o ContainerRegistryPresetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableContainerRegistryPresetsInner struct {
	value *ContainerRegistryPresetsInner
	isSet bool
}

func (v NullableContainerRegistryPresetsInner) Get() *ContainerRegistryPresetsInner {
	return v.value
}

func (v *NullableContainerRegistryPresetsInner) Set(val *ContainerRegistryPresetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableContainerRegistryPresetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableContainerRegistryPresetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContainerRegistryPresetsInner(val *ContainerRegistryPresetsInner) *NullableContainerRegistryPresetsInner {
	return &NullableContainerRegistryPresetsInner{value: val, isSet: true}
}

func (v NullableContainerRegistryPresetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContainerRegistryPresetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
