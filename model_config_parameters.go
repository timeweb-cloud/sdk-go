...
// SetMysql gets a reference to the given ConfigParametersMysql and assigns it to the Mysql field.
...
func (o *ConfigParameters) GetPostgres() ConfigParametersPostgres {
	if o == nil || IsNil(o.Postgres) {
		var ret ConfigParametersPostgres
		return ret
	}
	return *o.Postgres
}
...
// SetPostgres gets a reference to the given ConfigParametersPostgres and assigns it to the Postgres field.
