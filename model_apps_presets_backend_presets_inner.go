...
// checks if the AppsPresetsBackendPresetsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppsPresetsBackendPresetsInner{}

// AppsPresetsBackendPresetsInner struct for AppsPresetsBackendPresetsInner
type AppsPresetsBackendPresetsInner struct {
	// ID пресета.
	Id int32 `json:"id"`
	// Описание пресета.
...
func NewAppsPresetsBackendPresetsInner(id int32, descriptionShort string, price int32, cpu int32, ram int32, disk int32, location string) *AppsPresetsBackendPresetsInner {
	this := AppsPresetsBackendPresetsInner{}
	this.Id = id
...
func (o AppsPresetsBackendPresetsInner) MarshalJSON() ([]byte, error) {
...
func (o AppsPresetsBackendPresetsInner) ToMap() (map[string]interface{}, error) {
...
type NullableAppsPresetsBackendPresetsInner struct {
	value *AppsPresetsBackendPresetsInner
	isSet bool
}

func (v NullableAppsPresetsBackendPresetsInner) Get() *AppsPresetsBackendPresetsInner {
	return v.value
}

func (v *NullableAppsPresetsBackendPresetsInner) Set(val *AppsPresetsBackendPresetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAppsPresetsBackendPresetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAppsPresetsBackendPresetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppsPresetsBackendPresetsInner(val *AppsPresetsBackendPresetsInner) *NullableAppsPresetsBackendPresetsInner {
	return &NullableAppsPresetsBackendPresetsInner{value: val, isSet: true}
}

func (v NullableAppsPresetsBackendPresetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppsPresetsBackendPresetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
