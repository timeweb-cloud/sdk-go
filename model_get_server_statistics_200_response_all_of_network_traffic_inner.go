...
// checks if the GetServerStatistics200ResponseAllOfNetworkTrafficInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerStatistics200ResponseAllOfNetworkTrafficInner{}

// GetServerStatistics200ResponseAllOfNetworkTrafficInner struct for GetServerStatistics200ResponseAllOfNetworkTrafficInner
type GetServerStatistics200ResponseAllOfNetworkTrafficInner struct {
...
func NewGetServerStatistics200ResponseAllOfNetworkTrafficInner(loggedAt time.Time, incoming float32, outgoing float32) *GetServerStatistics200ResponseAllOfNetworkTrafficInner {
	this := GetServerStatistics200ResponseAllOfNetworkTrafficInner{}
...
func (o GetServerStatistics200ResponseAllOfNetworkTrafficInner) MarshalJSON() ([]byte, error) {
...
func (o GetServerStatistics200ResponseAllOfNetworkTrafficInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner struct {
	value *GetServerStatistics200ResponseAllOfNetworkTrafficInner
	isSet bool
}

func (v NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner) Get() *GetServerStatistics200ResponseAllOfNetworkTrafficInner {
	return v.value
}

func (v *NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner) Set(val *GetServerStatistics200ResponseAllOfNetworkTrafficInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerStatistics200ResponseAllOfNetworkTrafficInner(val *GetServerStatistics200ResponseAllOfNetworkTrafficInner) *NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner {
	return &NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner{value: val, isSet: true}
}

func (v NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerStatistics200ResponseAllOfNetworkTrafficInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
