...
// checks if the AutoReplyIsDisabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoReplyIsDisabled{}

// AutoReplyIsDisabled struct for AutoReplyIsDisabled
type AutoReplyIsDisabled struct {
...
func (o AutoReplyIsDisabled) MarshalJSON() ([]byte, error) {
...
func (o AutoReplyIsDisabled) ToMap() (map[string]interface{}, error) {
...
type NullableAutoReplyIsDisabled struct {
	value *AutoReplyIsDisabled
	isSet bool
}

func (v NullableAutoReplyIsDisabled) Get() *AutoReplyIsDisabled {
	return v.value
}

func (v *NullableAutoReplyIsDisabled) Set(val *AutoReplyIsDisabled) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoReplyIsDisabled) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoReplyIsDisabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoReplyIsDisabled(val *AutoReplyIsDisabled) *NullableAutoReplyIsDisabled {
	return &NullableAutoReplyIsDisabled{value: val, isSet: true}
}

func (v NullableAutoReplyIsDisabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoReplyIsDisabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
