...
// checks if the ConfigParametersPostgres type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigParametersPostgres{}

// ConfigParametersPostgres Параметры PostgreSQL (`postgres` | `postgres14` | `postgres15` | `postgres16` | `postgres17` | `postgres18`)
type ConfigParametersPostgres struct {
...
func (o ConfigParametersPostgres) MarshalJSON() ([]byte, error) {
...
func (o ConfigParametersPostgres) ToMap() (map[string]interface{}, error) {
...
type NullableConfigParametersPostgres struct {
	value *ConfigParametersPostgres
	isSet bool
}

func (v NullableConfigParametersPostgres) Get() *ConfigParametersPostgres {
	return v.value
}

func (v *NullableConfigParametersPostgres) Set(val *ConfigParametersPostgres) {
	v.value = val
	v.isSet = true
}

func (v NullableConfigParametersPostgres) IsSet() bool {
	return v.isSet
}

func (v *NullableConfigParametersPostgres) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConfigParametersPostgres(val *ConfigParametersPostgres) *NullableConfigParametersPostgres {
	return &NullableConfigParametersPostgres{value: val, isSet: true}
}

func (v NullableConfigParametersPostgres) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConfigParametersPostgres) UnmarshalJSON(src []byte) error {
	v.isSet = true
