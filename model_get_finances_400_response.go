...
// checks if the GetFinances400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFinances400Response{}

// GetFinances400Response struct for GetFinances400Response
type GetFinances400Response struct {
	// Короткий идентификатор, соответствующий возвращаемому коду состояния HTTP.
	StatusCode float32 `json:"status_code"`
	Message *GetFinances400ResponseMessage `json:"message,omitempty"`
...
func (o *GetFinances400Response) GetMessage() GetFinances400ResponseMessage {
	if o == nil || IsNil(o.Message) {
		var ret GetFinances400ResponseMessage
		return ret
	}
	return *o.Message
}
...
// SetMessage gets a reference to the given GetFinances400ResponseMessage and assigns it to the Message field.
...
func (o GetFinances400Response) MarshalJSON() ([]byte, error) {
...
func (o GetFinances400Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetFinances400Response struct {
	value *GetFinances400Response
	isSet bool
}

func (v NullableGetFinances400Response) Get() *GetFinances400Response {
	return v.value
}

func (v *NullableGetFinances400Response) Set(val *GetFinances400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFinances400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFinances400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFinances400Response(val *GetFinances400Response) *NullableGetFinances400Response {
	return &NullableGetFinances400Response{value: val, isSet: true}
}

func (v NullableGetFinances400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFinances400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
