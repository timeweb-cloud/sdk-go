...
// checks if the RegistryEdit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryEdit{}

// RegistryEdit struct for RegistryEdit
type RegistryEdit struct {
	...
	Configuration *RegistryInConfiguration `json:"configuration,omitempty"`
}
...
func (o *RegistryEdit) GetConfiguration() RegistryInConfiguration {
	if o == nil || IsNil(o.Configuration) {
		var ret RegistryInConfiguration
		return ret
	}
...
// SetConfiguration gets a reference to the given RegistryInConfiguration and assigns it to the Configuration field.
func (o *RegistryEdit) SetConfiguration(v RegistryInConfiguration) {
	o.Configuration = &v
}

func (o RegistryEdit) MarshalJSON() ([]byte, error) {
...
func (o RegistryEdit) ToMap() (map[string]interface{}, error) {
...
type NullableRegistryEdit struct {
	value *RegistryEdit
	isSet bool
}

func (v NullableRegistryEdit) Get() *RegistryEdit {
	return v.value
}

func (v *NullableRegistryEdit) Set(val *RegistryEdit) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistryEdit) IsSet() bool {
	return v.isSet
}

func (v *NullableRegistryEdit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegistryEdit(val *RegistryEdit) *NullableRegistryEdit {
	return &NullableRegistryEdit{value: val, isSet: true}
}

func (v NullableRegistryEdit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegistryEdit) UnmarshalJSON(src []byte) error {
	v.isSet = true
