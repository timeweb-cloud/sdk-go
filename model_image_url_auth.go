...
// checks if the ImageUrlAuth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageUrlAuth{}

// ImageUrlAuth struct for ImageUrlAuth
...
func (o ImageUrlAuth) MarshalJSON() ([]byte, error) {
...
func (o ImageUrlAuth) ToMap() (map[string]interface{}, error) {
...
type NullableImageUrlAuth struct {
	value *ImageUrlAuth
	isSet bool
}

func (v NullableImageUrlAuth) Get() *ImageUrlAuth {
	return v.value
}

func (v *NullableImageUrlAuth) Set(val *ImageUrlAuth) {
	v.value = val
	v.isSet = true
}

func (v NullableImageUrlAuth) IsSet() bool {
	return v.isSet
}

func (v *NullableImageUrlAuth) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageUrlAuth(val *ImageUrlAuth) *NullableImageUrlAuth {
	return &NullableImageUrlAuth{value: val, isSet: true}
}

func (v NullableImageUrlAuth) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageUrlAuth) UnmarshalJSON(src []byte) error {
	v.isSet = true
