...
// checks if the Use type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Use{}

// Use Оплата заявки на продление/регистрацию домена с баланса аккаунта
type Use struct {
...
func (o Use) MarshalJSON() ([]byte, error) {
...
func (o Use) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["money_source"] = o.MoneySource
	if !IsNil(o.PersonId) {
...
type NullableUse struct {
	value *Use
	isSet bool
}

func (v NullableUse) Get() *Use {
	return v.value
}

func (v *NullableUse) Set(val *Use) {
	v.value = val
	v.isSet = true
}

func (v NullableUse) IsSet() bool {
	return v.isSet
}

func (v *NullableUse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUse(val *Use) *NullableUse {
	return &NullableUse{value: val, isSet: true}
}

func (v NullableUse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUse) UnmarshalJSON(src []byte) error {
	v.isSet = true
