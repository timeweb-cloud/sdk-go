...
// checks if the DeploySettingsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploySettingsInner{}

// DeploySettingsInner struct for DeploySettingsInner
type DeploySettingsInner struct {
	// Название фреймворка.
...
func (o DeploySettingsInner) MarshalJSON() ([]byte, error) {
...
func (o DeploySettingsInner) ToMap() (map[string]interface{}, error) {
...
type NullableDeploySettingsInner struct {
	value *DeploySettingsInner
	isSet bool
}

func (v NullableDeploySettingsInner) Get() *DeploySettingsInner {
	return v.value
}

func (v *NullableDeploySettingsInner) Set(val *DeploySettingsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploySettingsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploySettingsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploySettingsInner(val *DeploySettingsInner) *NullableDeploySettingsInner {
	return &NullableDeploySettingsInner{value: val, isSet: true}
}

func (v NullableDeploySettingsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploySettingsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
