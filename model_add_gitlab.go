...
func (o AddGitlab) MarshalJSON() ([]byte, error) {
...
func (o AddGitlab) ToMap() (map[string]interface{}, error) {
...
type NullableAddGitlab struct {
	value *AddGitlab
	isSet bool
}

func (v NullableAddGitlab) Get() *AddGitlab {
	return v.value
}

func (v *NullableAddGitlab) Set(val *AddGitlab) {
	v.value = val
	v.isSet = true
}

func (v NullableAddGitlab) IsSet() bool {
	return v.isSet
}

func (v *NullableAddGitlab) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddGitlab(val *AddGitlab) *NullableAddGitlab {
	return &NullableAddGitlab{value: val, isSet: true}
}

func (v NullableAddGitlab) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddGitlab) UnmarshalJSON(src []byte) error {
	v.isSet = true
