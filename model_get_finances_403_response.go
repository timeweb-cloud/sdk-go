...
type GetFinances403Response struct {
	...
	Message *GetFinances403ResponseMessage `json:"message,omitempty"`
...
func (o *GetFinances403Response) GetMessage() GetFinances403ResponseMessage {
	if o == nil || IsNil(o.Message) {
		var ret GetFinances403ResponseMessage
		return ret
	}
	return *o.Message
}
...
// SetMessage gets a reference to the given GetFinances403ResponseMessage and assigns it to the Message field.
