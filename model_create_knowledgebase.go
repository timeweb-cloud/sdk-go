...
// checks if the CreateKnowledgebase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKnowledgebase{}

// CreateKnowledgebase Данные для создания базы знаний
type CreateKnowledgebase struct {
	...
	DbaasPresetId float32 `json:"dbaas_preset_id"`
	// ID сети
...
// GetDbaasPresetId returns the DbaasPresetId field value
func (o *CreateKnowledgebase) GetDbaasPresetId() float32 {
	...
	return o.DbaasPresetId
}

// GetDbaasPresetIdOk returns a tuple with the DbaasPresetId field value
// and a boolean to check if the value has been set.
func (o *CreateKnowledgebase) GetDbaasPresetIdOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DbaasPresetId, true
}

// SetDbaasPresetId sets field value
...
func (o CreateKnowledgebase) MarshalJSON() ([]byte, error) {
...
func (o CreateKnowledgebase) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	if !IsNil(o.Description) {
		toSerialize["description"] = o.Description
	}
	toSerialize["dbaas_preset_id"] = o.DbaasPresetId
...
type NullableCreateKnowledgebase struct {
	value *CreateKnowledgebase
	isSet bool
}

func (v NullableCreateKnowledgebase) Get() *CreateKnowledgebase {
	return v.value
}

func (v *NullableCreateKnowledgebase) Set(val *CreateKnowledgebase) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateKnowledgebase) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateKnowledgebase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateKnowledgebase(val *CreateKnowledgebase) *NullableCreateKnowledgebase {
	return &NullableCreateKnowledgebase{value: val, isSet: true}
}

func (v NullableCreateKnowledgebase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateKnowledgebase) UnmarshalJSON(src []byte) error {
	v.isSet = true
