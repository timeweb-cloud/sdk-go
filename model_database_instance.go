...
// checks if the DatabaseInstance type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseInstance{}

// DatabaseInstance База данных
...
func (o DatabaseInstance) MarshalJSON() ([]byte, error) {
...
func (o DatabaseInstance) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseInstance struct {
	value *DatabaseInstance
	isSet bool
}

func (v NullableDatabaseInstance) Get() *DatabaseInstance {
	return v.value
}

func (v *NullableDatabaseInstance) Set(val *DatabaseInstance) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseInstance) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseInstance) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseInstance(val *DatabaseInstance) *NullableDatabaseInstance {
	return &NullableDatabaseInstance{value: val, isSet: true}
}

func (v NullableDatabaseInstance) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseInstance) UnmarshalJSON(src []byte) error {
	v.isSet = true
