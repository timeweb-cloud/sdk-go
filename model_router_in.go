...
// checks if the RouterIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouterIn{}

// RouterIn struct for RouterIn
type RouterIn struct {
	...
	// Подключаемые сети
	Networks []RouterInNetworksInner `json:"networks"`
	// IP-адреса
	Ips []RouterInIpsInner `json:"ips,omitempty"`
	ParentService *RouterInParentService `json:"parent_service,omitempty"`
}
...
// SetIps gets a reference to the given []RouterInIpsInner and assigns it to the Ips field.
func (o *RouterIn) SetIps(v []RouterInIpsInner) {
	o.Ips = v
}

// GetParentService returns the ParentService field value if set, zero value otherwise.
func (o *RouterIn) GetParentService() RouterInParentService {
	if o == nil || IsNil(o.ParentService) {
		var ret RouterInParentService
		return ret
	}
	return *o.ParentService
}

// GetParentServiceOk returns a tuple with the ParentService field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RouterIn) GetParentServiceOk() (*RouterInParentService, bool) {
	if o == nil || IsNil(o.ParentService) {
		return nil, false
	}
	return o.ParentService, true
}
...
// SetParentService gets a reference to the given RouterInParentService and assigns it to the ParentService field.
func (o *RouterIn) SetParentService(v RouterInParentService) {
	o.ParentService = &v
}

func (o RouterIn) MarshalJSON() ([]byte, error) {
...
func (o RouterIn) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ParentService) {
		toSerialize["parent_service"] = o.ParentService
	}
	return toSerialize, nil
}

type NullableRouterIn struct {
	value *RouterIn
	isSet bool
}

func (v NullableRouterIn) Get() *RouterIn {
	return v.value
}

func (v *NullableRouterIn) Set(val *RouterIn) {
	v.value = val
	v.isSet = true
}

func (v NullableRouterIn) IsSet() bool {
	return v.isSet
}

func (v *NullableRouterIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouterIn(val *RouterIn) *NullableRouterIn {
	return &NullableRouterIn{value: val, isSet: true}
}

func (v NullableRouterIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouterIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
