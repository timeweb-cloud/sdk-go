...
// checks if the CreateBalancerCertificates type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateBalancerCertificates{}

// CreateBalancerCertificates Сертификат SSL.
type CreateBalancerCertificates struct {
	// Тип сертификата.
...
func NewCreateBalancerCertificates() *CreateBalancerCertificates {
	this := CreateBalancerCertificates{}
	return &this
}
...
func (o CreateBalancerCertificates) MarshalJSON() ([]byte, error) {
...
func (o CreateBalancerCertificates) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CertData) {
		toSerialize["cert_data"] = o.CertData
	}
	if !IsNil(o.KeyData) {
...
type NullableCreateBalancerCertificates struct {
	value *CreateBalancerCertificates
	isSet bool
}

func (v NullableCreateBalancerCertificates) Get() *CreateBalancerCertificates {
	return v.value
}

func (v *NullableCreateBalancerCertificates) Set(val *CreateBalancerCertificates) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBalancerCertificates) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBalancerCertificates) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBalancerCertificates(val *CreateBalancerCertificates) *NullableCreateBalancerCertificates {
	return &NullableCreateBalancerCertificates{value: val, isSet: true}
}

func (v NullableCreateBalancerCertificates) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBalancerCertificates) UnmarshalJSON(src []byte) error {
	v.isSet = true
