...
// checks if the K8SVersionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &K8SVersionsResponse{}
...
func (o K8SVersionsResponse) MarshalJSON() ([]byte, error) {
...
func (o K8SVersionsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableK8SVersionsResponse struct {
	value *K8SVersionsResponse
	isSet bool
}

func (v NullableK8SVersionsResponse) Get() *K8SVersionsResponse {
	return v.value
}

func (v *NullableK8SVersionsResponse) Set(val *K8SVersionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableK8SVersionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableK8SVersionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableK8SVersionsResponse(val *K8SVersionsResponse) *NullableK8SVersionsResponse {
	return &NullableK8SVersionsResponse{value: val, isSet: true}
}

func (v NullableK8SVersionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableK8SVersionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
