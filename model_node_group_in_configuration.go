...
// checks if the NodeGroupInConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeGroupInConfiguration{}

// NodeGroupInConfiguration Параметры конфигурации воркер-ноды. Нельзя передавать вместе с `preset_id`. Локация воркер-нод должна совпадать с локацией кластера
type NodeGroupInConfiguration struct {
...
func (o NodeGroupInConfiguration) ToMap() (map[string]interface{}, error) {
...
type NullableNodeGroupInConfiguration struct {
	value *NodeGroupInConfiguration
	isSet bool
}

func (v NullableNodeGroupInConfiguration) Get() *NodeGroupInConfiguration {
	return v.value
}

func (v *NullableNodeGroupInConfiguration) Set(val *NodeGroupInConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeGroupInConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeGroupInConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeGroupInConfiguration(val *NodeGroupInConfiguration) *NullableNodeGroupInConfiguration {
	return &NullableNodeGroupInConfiguration{value: val, isSet: true}
}

func (v NullableNodeGroupInConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeGroupInConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
