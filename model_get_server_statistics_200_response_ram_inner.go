...
// checks if the GetServerStatistics200ResponseRamInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerStatistics200ResponseRamInner{}

// GetServerStatistics200ResponseRamInner struct for GetServerStatistics200ResponseRamInner
type GetServerStatistics200ResponseRamInner struct {
...
func NewGetServerStatistics200ResponseRamInner(loggedAt time.Time, total float32, used float32, usedCached float32, available float32) *GetServerStatistics200ResponseRamInner {
	this := GetServerStatistics200ResponseRamInner{}
...
func (o GetServerStatistics200ResponseRamInner) MarshalJSON() ([]byte, error) {
...
func (o GetServerStatistics200ResponseRamInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerStatistics200ResponseRamInner struct {
	value *GetServerStatistics200ResponseRamInner
	isSet bool
}

func (v NullableGetServerStatistics200ResponseRamInner) Get() *GetServerStatistics200ResponseRamInner {
	return v.value
}

func (v *NullableGetServerStatistics200ResponseRamInner) Set(val *GetServerStatistics200ResponseRamInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerStatistics200ResponseRamInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerStatistics200ResponseRamInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerStatistics200ResponseRamInner(val *GetServerStatistics200ResponseRamInner) *NullableGetServerStatistics200ResponseRamInner {
	return &NullableGetServerStatistics200ResponseRamInner{value: val, isSet: true}
}

func (v NullableGetServerStatistics200ResponseRamInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerStatistics200ResponseRamInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
