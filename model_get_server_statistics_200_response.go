...
// checks if the GetServerStatistics200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerStatistics200Response{}
...
func (o GetServerStatistics200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerStatistics200Response struct {
	value *GetServerStatistics200Response
	isSet bool
}

func (v NullableGetServerStatistics200Response) Get() *GetServerStatistics200Response {
	return v.value
}

func (v *NullableGetServerStatistics200Response) Set(val *GetServerStatistics200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerStatistics200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerStatistics200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerStatistics200Response(val *GetServerStatistics200Response) *NullableGetServerStatistics200Response {
	return &NullableGetServerStatistics200Response{value: val, isSet: true}
}

func (v NullableGetServerStatistics200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerStatistics200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
