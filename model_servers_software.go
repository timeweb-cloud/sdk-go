...
// checks if the ServersSoftware type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServersSoftware{}

// ServersSoftware struct for ServersSoftware
type ServersSoftware struct {
	...
	Requirements *ServersSoftwareRequirements `json:"requirements,omitempty"`
}
...
// SetOsIds gets a reference to the given []float32 and assigns it to the OsIds field.
...
// SetInstallations gets a reference to the given float32 and assigns it to the Installations field.
...
func (o *ServersSoftware) GetRequirements() ServersSoftwareRequirements {
	if o == nil || IsNil(o.Requirements) {
		var ret ServersSoftwareRequirements
		return ret
	}
...
// SetRequirements gets a reference to the given ServersSoftwareRequirements and assigns it to the Requirements field.
func (o *ServersSoftware) SetRequirements(v ServersSoftwareRequirements) {
	o.Requirements = &v
}

func (o ServersSoftware) MarshalJSON() ([]byte, error) {
...
func (o ServersSoftware) ToMap() (map[string]interface{}, error) {
...
type NullableServersSoftware struct {
	value *ServersSoftware
	isSet bool
}

func (v NullableServersSoftware) Get() *ServersSoftware {
	return v.value
}

func (v *NullableServersSoftware) Set(val *ServersSoftware) {
	v.value = val
	v.isSet = true
}

func (v NullableServersSoftware) IsSet() bool {
	return v.isSet
}

func (v *NullableServersSoftware) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServersSoftware(val *ServersSoftware) *NullableServersSoftware {
	return &NullableServersSoftware{value: val, isSet: true}
}

func (v NullableServersSoftware) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServersSoftware) UnmarshalJSON(src []byte) error {
	v.isSet = true
