...
// checks if the AvailableNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailableNetwork{}

// AvailableNetwork struct for AvailableNetwork
...
func (o AvailableNetwork) MarshalJSON() ([]byte, error) {
...
func (o AvailableNetwork) ToMap() (map[string]interface{}, error) {
...
type NullableAvailableNetwork struct {
	value *AvailableNetwork
	isSet bool
}

func (v NullableAvailableNetwork) Get() *AvailableNetwork {
	return v.value
}

func (v *NullableAvailableNetwork) Set(val *AvailableNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailableNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailableNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailableNetwork(val *AvailableNetwork) *NullableAvailableNetwork {
	return &NullableAvailableNetwork{value: val, isSet: true}
}

func (v NullableAvailableNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailableNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
