...
// checks if the StaticRouteIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticRouteIn{}

// StaticRouteIn struct for StaticRouteIn
...
func (o StaticRouteIn) MarshalJSON() ([]byte, error) {
...
func (o StaticRouteIn) ToMap() (map[string]interface{}, error) {
...
type NullableStaticRouteIn struct {
	value *StaticRouteIn
	isSet bool
}

func (v NullableStaticRouteIn) Get() *StaticRouteIn {
	return v.value
}

func (v *NullableStaticRouteIn) Set(val *StaticRouteIn) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticRouteIn) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticRouteIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticRouteIn(val *StaticRouteIn) *NullableStaticRouteIn {
	return &NullableStaticRouteIn{value: val, isSet: true}
}

func (v NullableStaticRouteIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticRouteIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
