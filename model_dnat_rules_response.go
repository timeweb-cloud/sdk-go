...
// checks if the DnatRulesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnatRulesResponse{}

// DnatRulesResponse struct for DnatRulesResponse
...
func (o DnatRulesResponse) MarshalJSON() ([]byte, error) {
...
func (o DnatRulesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResponseId) {
		toSerialize["response_id"] = o.ResponseId
	}
	toSerialize["dnat_rules"] = o.DnatRules
	toSerialize["meta"] = o.Meta
	return toSerialize, nil
}

type NullableDnatRulesResponse struct {
	value *DnatRulesResponse
	isSet bool
}

func (v NullableDnatRulesResponse) Get() *DnatRulesResponse {
	return v.value
}

func (v *NullableDnatRulesResponse) Set(val *DnatRulesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDnatRulesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDnatRulesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnatRulesResponse(val *DnatRulesResponse) *NullableDnatRulesResponse {
	return &NullableDnatRulesResponse{value: val, isSet: true}
}

func (v NullableDnatRulesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnatRulesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
