...
// checks if the CreateNetworkDrive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkDrive{}

// CreateNetworkDrive struct for CreateNetworkDrive
type CreateNetworkDrive struct {
...
func (o *CreateNetworkDrive) SetCommentNil() {
	o.Comment.Set(nil)
}
...
func (o CreateNetworkDrive) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkDrive) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkDrive struct {
	value *CreateNetworkDrive
	isSet bool
}

func (v NullableCreateNetworkDrive) Get() *CreateNetworkDrive {
	return v.value
}

func (v *NullableCreateNetworkDrive) Set(val *CreateNetworkDrive) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkDrive) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkDrive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkDrive(val *CreateNetworkDrive) *NullableCreateNetworkDrive {
	return &NullableCreateNetworkDrive{value: val, isSet: true}
}

func (v NullableCreateNetworkDrive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkDrive) UnmarshalJSON(src []byte) error {
	v.isSet = true
