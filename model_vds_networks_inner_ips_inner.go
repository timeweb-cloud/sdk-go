...
// checks if the VdsNetworksInnerIpsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VdsNetworksInnerIpsInner{}

// VdsNetworksInnerIpsInner struct for VdsNetworksInnerIpsInner
...
func (o VdsNetworksInnerIpsInner) MarshalJSON() ([]byte, error) {
...
func (o VdsNetworksInnerIpsInner) ToMap() (map[string]interface{}, error) {
...
type NullableVdsNetworksInnerIpsInner struct {
	value *VdsNetworksInnerIpsInner
	isSet bool
}

func (v NullableVdsNetworksInnerIpsInner) Get() *VdsNetworksInnerIpsInner {
	return v.value
}

func (v *NullableVdsNetworksInnerIpsInner) Set(val *VdsNetworksInnerIpsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableVdsNetworksInnerIpsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableVdsNetworksInnerIpsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVdsNetworksInnerIpsInner(val *VdsNetworksInnerIpsInner) *NullableVdsNetworksInnerIpsInner {
	return &NullableVdsNetworksInnerIpsInner{value: val, isSet: true}
}

func (v NullableVdsNetworksInnerIpsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVdsNetworksInnerIpsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
