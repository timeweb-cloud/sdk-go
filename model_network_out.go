...
// checks if the NetworkOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkOut{}

// NetworkOut struct for NetworkOut
...
// GetReservedIps returns the ReservedIps field value
...
// GetReservedIpsOk returns a tuple with the ReservedIps field value
// and a boolean to check if the value has been set.
...
// SetReservedIps sets field value
...
// GetBusyAddresses returns the BusyAddresses field value
func (o *NetworkOut) GetBusyAddresses() []string {
	...
	return o.BusyAddresses
}

// GetBusyAddressesOk returns a tuple with the BusyAddresses field value
// and a boolean to check if the value has been set.
func (o *NetworkOut) GetBusyAddressesOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.BusyAddresses, true
}

// SetBusyAddresses sets field value
func (o *NetworkOut) SetBusyAddresses(v []string) {
	o.BusyAddresses = v
}

func (o NetworkOut) MarshalJSON() ([]byte, error) {
...
func (o NetworkOut) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["busy_addresses"] = o.BusyAddresses
	return toSerialize, nil
}

type NullableNetworkOut struct {
	value *NetworkOut
	isSet bool
}

func (v NullableNetworkOut) Get() *NetworkOut {
	return v.value
}

func (v *NullableNetworkOut) Set(val *NetworkOut) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkOut) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkOut(val *NetworkOut) *NullableNetworkOut {
	return &NullableNetworkOut{value: val, isSet: true}
}

func (v NullableNetworkOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
