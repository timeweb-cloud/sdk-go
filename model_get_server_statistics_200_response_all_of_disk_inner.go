...
// checks if the GetServerStatistics200ResponseAllOfDiskInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerStatistics200ResponseAllOfDiskInner{}

// GetServerStatistics200ResponseAllOfDiskInner struct for GetServerStatistics200ResponseAllOfDiskInner
type GetServerStatistics200ResponseAllOfDiskInner struct {
...
func NewGetServerStatistics200ResponseAllOfDiskInner(loggedAt time.Time, write float32, read float32) *GetServerStatistics200ResponseAllOfDiskInner {
	this := GetServerStatistics200ResponseAllOfDiskInner{}
...
func (o GetServerStatistics200ResponseAllOfDiskInner) MarshalJSON() ([]byte, error) {
...
func (o GetServerStatistics200ResponseAllOfDiskInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerStatistics200ResponseAllOfDiskInner struct {
	value *GetServerStatistics200ResponseAllOfDiskInner
	isSet bool
}

func (v NullableGetServerStatistics200ResponseAllOfDiskInner) Get() *GetServerStatistics200ResponseAllOfDiskInner {
	return v.value
}

func (v *NullableGetServerStatistics200ResponseAllOfDiskInner) Set(val *GetServerStatistics200ResponseAllOfDiskInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerStatistics200ResponseAllOfDiskInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerStatistics200ResponseAllOfDiskInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerStatistics200ResponseAllOfDiskInner(val *GetServerStatistics200ResponseAllOfDiskInner) *NullableGetServerStatistics200ResponseAllOfDiskInner {
	return &NullableGetServerStatistics200ResponseAllOfDiskInner{value: val, isSet: true}
}

func (v NullableGetServerStatistics200ResponseAllOfDiskInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerStatistics200ResponseAllOfDiskInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
