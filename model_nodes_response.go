...
// checks if the NodesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodesResponse{}

// NodesResponse struct for NodesResponse
...
func (o NodesResponse) MarshalJSON() ([]byte, error) {
...
func (o NodesResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNodesResponse struct {
	value *NodesResponse
	isSet bool
}

func (v NullableNodesResponse) Get() *NodesResponse {
	return v.value
}

func (v *NullableNodesResponse) Set(val *NodesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNodesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNodesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodesResponse(val *NodesResponse) *NullableNodesResponse {
	return &NullableNodesResponse{value: val, isSet: true}
}

func (v NullableNodesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
