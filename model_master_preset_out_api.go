...
// checks if the MasterPresetOutApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MasterPresetOutApi{}

// MasterPresetOutApi struct for MasterPresetOutApi
...
func (o MasterPresetOutApi) MarshalJSON() ([]byte, error) {
...
func (o MasterPresetOutApi) ToMap() (map[string]interface{}, error) {
...
type NullableMasterPresetOutApi struct {
	value *MasterPresetOutApi
	isSet bool
}

func (v NullableMasterPresetOutApi) Get() *MasterPresetOutApi {
	return v.value
}

func (v *NullableMasterPresetOutApi) Set(val *MasterPresetOutApi) {
	v.value = val
	v.isSet = true
}

func (v NullableMasterPresetOutApi) IsSet() bool {
	return v.isSet
}

func (v *NullableMasterPresetOutApi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMasterPresetOutApi(val *MasterPresetOutApi) *NullableMasterPresetOutApi {
	return &NullableMasterPresetOutApi{value: val, isSet: true}
}

func (v NullableMasterPresetOutApi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMasterPresetOutApi) UnmarshalJSON(src []byte) error {
	v.isSet = true
