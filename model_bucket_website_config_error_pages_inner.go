...
// checks if the BucketWebsiteConfigErrorPagesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BucketWebsiteConfigErrorPagesInner{}

// BucketWebsiteConfigErrorPagesInner struct for BucketWebsiteConfigErrorPagesInner
...
func NewBucketWebsiteConfigErrorPagesInner() *BucketWebsiteConfigErrorPagesInner {
	this := BucketWebsiteConfigErrorPagesInner{}
	return &this
}
...
func (o BucketWebsiteConfigErrorPagesInner) MarshalJSON() ([]byte, error) {
...
func (o BucketWebsiteConfigErrorPagesInner) ToMap() (map[string]interface{}, error) {
...
type NullableBucketWebsiteConfigErrorPagesInner struct {
	value *BucketWebsiteConfigErrorPagesInner
	isSet bool
}

func (v NullableBucketWebsiteConfigErrorPagesInner) Get() *BucketWebsiteConfigErrorPagesInner {
	return v.value
}

func (v *NullableBucketWebsiteConfigErrorPagesInner) Set(val *BucketWebsiteConfigErrorPagesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBucketWebsiteConfigErrorPagesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBucketWebsiteConfigErrorPagesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBucketWebsiteConfigErrorPagesInner(val *BucketWebsiteConfigErrorPagesInner) *NullableBucketWebsiteConfigErrorPagesInner {
	return &NullableBucketWebsiteConfigErrorPagesInner{value: val, isSet: true}
}

func (v NullableBucketWebsiteConfigErrorPagesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBucketWebsiteConfigErrorPagesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
