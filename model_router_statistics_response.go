...
// checks if the RouterStatisticsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouterStatisticsResponse{}

// RouterStatisticsResponse struct for RouterStatisticsResponse
...
func (o RouterStatisticsResponse) MarshalJSON() ([]byte, error) {
...
func (o RouterStatisticsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRouterStatisticsResponse struct {
	value *RouterStatisticsResponse
	isSet bool
}

func (v NullableRouterStatisticsResponse) Get() *RouterStatisticsResponse {
	return v.value
}

func (v *NullableRouterStatisticsResponse) Set(val *RouterStatisticsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRouterStatisticsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRouterStatisticsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouterStatisticsResponse(val *RouterStatisticsResponse) *NullableRouterStatisticsResponse {
	return &NullableRouterStatisticsResponse{value: val, isSet: true}
}

func (v NullableRouterStatisticsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouterStatisticsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
