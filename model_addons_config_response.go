...
// checks if the AddonsConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddonsConfigResponse{}

// AddonsConfigResponse struct for AddonsConfigResponse
...
// GetK8sAddons returns the K8sAddons field value
func (o *AddonsConfigResponse) GetK8sAddons() []AddonConfigOut {
	if o == nil {
		var ret []AddonConfigOut
		return ret
	}
...
// GetK8sAddonsOk returns a tuple with the K8sAddons field value
// and a boolean to check if the value has been set.
func (o *AddonsConfigResponse) GetK8sAddonsOk() ([]AddonConfigOut, bool) {
	if o == nil {
		return nil, false
	}
	return o.K8sAddons, true
}

// SetK8sAddons sets field value
func (o *AddonsConfigResponse) SetK8sAddons(v []AddonConfigOut) {
	o.K8sAddons = v
}

func (o AddonsConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o AddonsConfigResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResponseId) {
		toSerialize["response_id"] = o.ResponseId
	}
	toSerialize["meta"] = o.Meta
	toSerialize["k8s_addons"] = o.K8sAddons
	return toSerialize, nil
}

type NullableAddonsConfigResponse struct {
	value *AddonsConfigResponse
	isSet bool
}

func (v NullableAddonsConfigResponse) Get() *AddonsConfigResponse {
	return v.value
}

func (v *NullableAddonsConfigResponse) Set(val *AddonsConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddonsConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddonsConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddonsConfigResponse(val *AddonsConfigResponse) *NullableAddonsConfigResponse {
	return &NullableAddonsConfigResponse{value: val, isSet: true}
}

func (v NullableAddonsConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddonsConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
