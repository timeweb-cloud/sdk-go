...
// checks if the PresetsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PresetsResponse{}

// PresetsResponse struct for PresetsResponse
...
func (o PresetsResponse) MarshalJSON() ([]byte, error) {
...
func (o PresetsResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePresetsResponse struct {
	value *PresetsResponse
	isSet bool
}

func (v NullablePresetsResponse) Get() *PresetsResponse {
	return v.value
}

func (v *NullablePresetsResponse) Set(val *PresetsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePresetsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePresetsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePresetsResponse(val *PresetsResponse) *NullablePresetsResponse {
	return &NullablePresetsResponse{value: val, isSet: true}
}

func (v NullablePresetsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePresetsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
