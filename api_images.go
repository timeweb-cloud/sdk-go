...
func (r ApiCreateImageRequest) ImageInAPI(imageInAPI ImageInAPI) ApiCreateImageRequest {
	r.imageInAPI = &imageInAPI
	return r
}
...
func (a *ImagesAPIService) CreateImageExecute(r ApiCreateImageRequest) (*ImageOutResponse, *http.Response, error) {
	...
	if r.imageInAPI == nil {
		return localVarReturnValue, nil, reportError("imageInAPI is required and must be specified")
	}
...
type ApiCreateImageDownloadUrlRequest struct {
	ctx context.Context
	ApiService *ImagesAPIService
	imageId string
...
func (r ApiCreateImageDownloadUrlRequest) ImageUrlIn(imageUrlIn ImageUrlIn) ApiCreateImageDownloadUrlRequest {
	r.imageUrlIn = &imageUrlIn
	return r
}
...
/*
CreateImageDownloadUrl Создание ссылки на скачивание образа
...
func (a *ImagesAPIService) CreateImageDownloadUrlExecute(r ApiCreateImageDownloadUrlRequest) (*ImageDownloadResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/images/{image_id}/download-url"
	...
	localVarFormParams := url.Values{}
	if r.imageUrlIn == nil {
		return localVarReturnValue, nil, reportError("imageUrlIn is required and must be specified")
	}
...
type ApiDeleteImageDownloadURLRequest struct {
	ctx context.Context
	ApiService *ImagesAPIService
	imageId string
	imageUrlId string
...
func (r ApiDeleteImageDownloadURLRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteImageDownloadURLExecute(r)
}

/*
DeleteImageDownloadURL Удаление ссылки на образ
...
// Execute executes the request
func (a *ImagesAPIService) DeleteImageDownloadURLExecute(r ApiDeleteImageDownloadURLRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ImagesAPIService.DeleteImageDownloadURL")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/images/{image_id}/download-url/{image_url_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"image_id"+"}", url.PathEscape(parameterValueToString(r.imageId, "imageId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"image_url_id"+"}", url.PathEscape(parameterValueToString(r.imageUrlId, "imageUrlId")), -1)
...
/*
GetImage Получение информации о образе
...
type ApiGetImageDownloadURLRequest struct {
	ctx context.Context
	ApiService *ImagesAPIService
	imageId string
	imageUrlId string
...
/*
GetImageDownloadURL Получение информации о ссылке на скачивание образа
...
type ApiGetImageDownloadURLsRequest struct {
	ctx context.Context
	ApiService *ImagesAPIService
	imageId string
	limit *int32
...
func (r ApiGetImageDownloadURLsRequest) Limit(limit int32) ApiGetImageDownloadURLsRequest {
	r.limit = &limit
	return r
}

func (r ApiGetImageDownloadURLsRequest) Offset(offset int32) ApiGetImageDownloadURLsRequest {
	r.offset = &offset
	return r
}
...
/*
GetImageDownloadURLs Получение информации о ссылках на скачивание образов
...
/*
GetImages Получение списка образов
...
func (r ApiUpdateImageRequest) ImageUpdateAPI(imageUpdateAPI ImageUpdateAPI) ApiUpdateImageRequest {
	r.imageUpdateAPI = &imageUpdateAPI
	return r
}
...
/*
UpdateImage Обновление информации о образе
...
func (a *ImagesAPIService) UpdateImageExecute(r ApiUpdateImageRequest) (*ImageOutResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.imageUpdateAPI == nil {
		return localVarReturnValue, nil, reportError("imageUpdateAPI is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.imageUpdateAPI
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiUploadImageRequest) ContentDisposition(contentDisposition string) ApiUploadImageRequest {
...
*/
func (a *ImagesAPIService) UploadImage(ctx context.Context, imageId string) ApiUploadImageRequest {
	return ApiUploadImageRequest{
		ApiService: a,
		ctx: ctx,
		imageId: imageId,
