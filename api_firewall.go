...
type ApiAddResourceToGroupRequest struct {
	ctx context.Context
...
func (r ApiAddResourceToGroupRequest) ResourceType(resourceType ResourceType) ApiAddResourceToGroupRequest {
...
/*
AddResourceToGroup Линковка ресурса в firewall group
...
*/
func (a *FirewallAPIService) AddResourceToGroup(ctx context.Context, groupId string, resourceId string) ApiAddResourceToGroupRequest {
	return ApiAddResourceToGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *FirewallAPIService) AddResourceToGroupExecute(r ApiAddResourceToGroupRequest) (*FirewallGroupResourceOutResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/firewall/groups/{group_id}/resources/{resource_id}"
...
/*
CreateGroup Создание группы правил
...
*/
func (a *FirewallAPIService) CreateGroup(ctx context.Context) ApiCreateGroupRequest {
	return ApiCreateGroupRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *FirewallAPIService) CreateGroupExecute(r ApiCreateGroupRequest) (*FirewallGroupOutResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/firewall/groups"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.firewallGroupInAPI == nil {
	...
	// body params
	localVarPostBody = r.firewallGroupInAPI
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiCreateGroupRuleRequest) FirewallRuleInAPI(firewallRuleInAPI FirewallRuleInAPI) ApiCreateGroupRuleRequest {
	r.firewallRuleInAPI = &firewallRuleInAPI
	return r
}
...
/*
CreateGroupRule Создание firewall правила
...
func (a *FirewallAPIService) CreateGroupRuleExecute(r ApiCreateGroupRuleRequest) (*FirewallRuleOutResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/firewall/groups/{group_id}/rules"
	localVarPath = strings.Replace(localVarPath, "{"+"group_id"+"}", url.PathEscape(parameterValueToString(r.groupId, "groupId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.firewallRuleInAPI == nil {
		return localVarReturnValue, nil, reportError("firewallRuleInAPI is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.firewallRuleInAPI
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
DeleteGroup Удаление группы правил
...
// Execute executes the request
func (a *FirewallAPIService) DeleteGroupExecute(r ApiDeleteGroupRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirewallAPIService.DeleteGroup")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/firewall/groups/{group_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"group_id"+"}", url.PathEscape(parameterValueToString(r.groupId, "groupId")), -1)
...
func (r ApiDeleteGroupRuleRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteGroupRuleExecute(r)
}

/*
DeleteGroupRule Удаление firewall правила
...
*/
func (a *FirewallAPIService) DeleteGroupRule(ctx context.Context, groupId string, ruleId string) ApiDeleteGroupRuleRequest {
	return ApiDeleteGroupRuleRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *FirewallAPIService) DeleteGroupRuleExecute(r ApiDeleteGroupRuleRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirewallAPIService.DeleteGroupRule")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/firewall/groups/{group_id}/rules/{rule_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"group_id"+"}", url.PathEscape(parameterValueToString(r.groupId, "groupId")), -1)
...
type ApiDeleteResourceFromGroupRequest struct {
	ctx context.Context
	ApiService *FirewallAPIService
	groupId string
	resourceId string
...
func (r ApiDeleteResourceFromGroupRequest) ResourceType(resourceType ResourceType) ApiDeleteResourceFromGroupRequest {
	r.resourceType = &resourceType
	return r
}

func (r ApiDeleteResourceFromGroupRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteResourceFromGroupExecute(r)
}

/*
DeleteResourceFromGroup Отлинковка ресурса из firewall group
...
*/
func (a *FirewallAPIService) DeleteResourceFromGroup(ctx context.Context, groupId string, resourceId string) ApiDeleteResourceFromGroupRequest {
	return ApiDeleteResourceFromGroupRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
// Execute executes the request
func (a *FirewallAPIService) DeleteResourceFromGroupExecute(r ApiDeleteResourceFromGroupRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FirewallAPIService.DeleteResourceFromGroup")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
/*
GetGroup Получение информации о группе правил
...
func (r ApiGetGroupResourcesRequest) Limit(limit int32) ApiGetGroupResourcesRequest {
	r.limit = &limit
	return r
}

// Указывает на смещение относительно начала списка.
func (r ApiGetGroupResourcesRequest) Offset(offset int32) ApiGetGroupResourcesRequest {
	r.offset = &offset
	return r
}
...
/*
GetGroupResources Получение слинкованных ресурсов
...
func (a *FirewallAPIService) GetGroupResourcesExecute(r ApiGetGroupResourcesRequest) (*FirewallGroupResourcesOutResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/firewall/groups/{group_id}/resources"
	localVarPath = strings.Replace(localVarPath, "{"+"group_id"+"}", url.PathEscape(parameterValueToString(r.groupId, "groupId")), -1)
...
/*
GetGroupRule Получение информации о правиле
...
type ApiGetGroupRulesRequest struct {
	ctx context.Context
	ApiService *FirewallAPIService
	groupId string
	limit *int32
...
// Обозначает количество записей, которое необходимо вернуть.
func (r ApiGetGroupRulesRequest) Limit(limit int32) ApiGetGroupRulesRequest {
	r.limit = &limit
	return r
}

// Указывает на смещение относительно начала списка.
func (r ApiGetGroupRulesRequest) Offset(offset int32) ApiGetGroupRulesRequest {
	r.offset = &offset
	return r
}
...
/*
GetGroupRules Получение списка правил
...
/*
GetGroups Получение групп правил
...
*/
func (a *FirewallAPIService) GetGroups(ctx context.Context) ApiGetGroupsRequest {
	return ApiGetGroupsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
type ApiGetRulesForResourceRequest struct {
	ctx context.Context
	ApiService *FirewallAPIService
	resourceId string
	resourceType ResourceType
...
// Обозначает количество записей, которое необходимо вернуть.
func (r ApiGetRulesForResourceRequest) Limit(limit int32) ApiGetRulesForResourceRequest {
	r.limit = &limit
	return r
}

// Указывает на смещение относительно начала списка.
func (r ApiGetRulesForResourceRequest) Offset(offset int32) ApiGetRulesForResourceRequest {
	r.offset = &offset
	return r
}
...
/*
GetRulesForResource Получение групп правил для ресурса
...
*/
func (a *FirewallAPIService) GetRulesForResource(ctx context.Context, resourceId string, resourceType ResourceType) ApiGetRulesForResourceRequest {
	return ApiGetRulesForResourceRequest{
		ApiService: a,
		ctx: ctx,
		resourceId: resourceId,
...
func (a *FirewallAPIService) GetRulesForResourceExecute(r ApiGetRulesForResourceRequest) (*FirewallGroupsOutResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/firewall/service/{resource_type}/{resource_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"resource_id"+"}", url.PathEscape(parameterValueToString(r.resourceId, "resourceId")), -1)
...
func (r ApiUpdateGroupRequest) FirewallGroupInAPI(firewallGroupInAPI FirewallGroupInAPI) ApiUpdateGroupRequest {
	r.firewallGroupInAPI = &firewallGroupInAPI
	return r
}
...
/*
UpdateGroup Обновление группы правил
...
func (r ApiUpdateGroupRuleRequest) FirewallRuleInAPI(firewallRuleInAPI FirewallRuleInAPI) ApiUpdateGroupRuleRequest {
	r.firewallRuleInAPI = &firewallRuleInAPI
	return r
}
...
/*
UpdateGroupRule Обновление firewall правила
...
*/
func (a *FirewallAPIService) UpdateGroupRule(ctx context.Context, groupId string, ruleId string) ApiUpdateGroupRuleRequest {
	return ApiUpdateGroupRuleRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
