...
// checks if the ResourceTransfer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceTransfer{}
...
// GetToProject returns the ToProject field value
...
// GetToProjectOk returns a tuple with the ToProject field value
// and a boolean to check if the value has been set.
func (o *ResourceTransfer) GetToProjectOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ToProject, true
}

// SetToProject sets field value
...
func (o ResourceTransfer) MarshalJSON() ([]byte, error) {
...
func (o ResourceTransfer) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["to_project"] = o.ToProject
	toSerialize["resource_id"] = o.ResourceId
	toSerialize["resource_type"] = o.ResourceType
	return toSerialize, nil
}

type NullableResourceTransfer struct {
	value *ResourceTransfer
	isSet bool
}

func (v NullableResourceTransfer) Get() *ResourceTransfer {
	return v.value
}

func (v *NullableResourceTransfer) Set(val *ResourceTransfer) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceTransfer) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceTransfer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceTransfer(val *ResourceTransfer) *NullableResourceTransfer {
	return &NullableResourceTransfer{value: val, isSet: true}
}

func (v NullableResourceTransfer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceTransfer) UnmarshalJSON(src []byte) error {
	v.isSet = true
