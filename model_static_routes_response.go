...
// checks if the StaticRoutesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticRoutesResponse{}

// StaticRoutesResponse struct for StaticRoutesResponse
...
func (o StaticRoutesResponse) MarshalJSON() ([]byte, error) {
...
func (o StaticRoutesResponse) ToMap() (map[string]interface{}, error) {
...
type NullableStaticRoutesResponse struct {
	value *StaticRoutesResponse
	isSet bool
}

func (v NullableStaticRoutesResponse) Get() *StaticRoutesResponse {
	return v.value
}

func (v *NullableStaticRoutesResponse) Set(val *StaticRoutesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticRoutesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticRoutesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticRoutesResponse(val *StaticRoutesResponse) *NullableStaticRoutesResponse {
	return &NullableStaticRoutesResponse{value: val, isSet: true}
}

func (v NullableStaticRoutesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticRoutesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
