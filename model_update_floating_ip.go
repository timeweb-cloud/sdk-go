...
// checks if the UpdateFloatingIp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateFloatingIp{}

// UpdateFloatingIp struct for UpdateFloatingIp
...
func (o UpdateFloatingIp) MarshalJSON() ([]byte, error) {
...
func (o UpdateFloatingIp) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateFloatingIp struct {
	value *UpdateFloatingIp
	isSet bool
}

func (v NullableUpdateFloatingIp) Get() *UpdateFloatingIp {
	return v.value
}

func (v *NullableUpdateFloatingIp) Set(val *UpdateFloatingIp) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateFloatingIp) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateFloatingIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateFloatingIp(val *UpdateFloatingIp) *NullableUpdateFloatingIp {
	return &NullableUpdateFloatingIp{value: val, isSet: true}
}

func (v NullableUpdateFloatingIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateFloatingIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
