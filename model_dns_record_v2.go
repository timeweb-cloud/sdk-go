...
// checks if the DnsRecordV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnsRecordV2{}

// DnsRecordV2 DNS-запись.
type DnsRecordV2 struct {
	...
	Data DnsRecordV2Data `json:"data"`
...
func (o DnsRecordV2) MarshalJSON() ([]byte, error) {
...
func (o DnsRecordV2) ToMap() (map[string]interface{}, error) {
...
type NullableDnsRecordV2 struct {
	value *DnsRecordV2
	isSet bool
}

func (v NullableDnsRecordV2) Get() *DnsRecordV2 {
	return v.value
}

func (v *NullableDnsRecordV2) Set(val *DnsRecordV2) {
	v.value = val
	v.isSet = true
}

func (v NullableDnsRecordV2) IsSet() bool {
	return v.isSet
}

func (v *NullableDnsRecordV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnsRecordV2(val *DnsRecordV2) *NullableDnsRecordV2 {
	return &NullableDnsRecordV2{value: val, isSet: true}
}

func (v NullableDnsRecordV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnsRecordV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
