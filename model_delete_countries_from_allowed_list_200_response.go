...
// checks if the DeleteCountriesFromAllowedList200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeleteCountriesFromAllowedList200Response{}
...
type NullableDeleteCountriesFromAllowedList200Response struct {
	value *DeleteCountriesFromAllowedList200Response
	isSet bool
}

func (v NullableDeleteCountriesFromAllowedList200Response) Get() *DeleteCountriesFromAllowedList200Response {
	return v.value
}

func (v *NullableDeleteCountriesFromAllowedList200Response) Set(val *DeleteCountriesFromAllowedList200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteCountriesFromAllowedList200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteCountriesFromAllowedList200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteCountriesFromAllowedList200Response(val *DeleteCountriesFromAllowedList200Response) *NullableDeleteCountriesFromAllowedList200Response {
	return &NullableDeleteCountriesFromAllowedList200Response{value: val, isSet: true}
}

func (v NullableDeleteCountriesFromAllowedList200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteCountriesFromAllowedList200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
