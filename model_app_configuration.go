...
// SetNetworkBandwidth gets a reference to the given float32 and assigns it to the NetworkBandwidth field.
...
func (o AppConfiguration) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NetworkBandwidth) {
		toSerialize["network_bandwidth"] = o.NetworkBandwidth
	}
