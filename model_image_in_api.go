...
// checks if the ImageInAPI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageInAPI{}
...
func (o ImageInAPI) ToMap() (map[string]interface{}, error) {
...
type NullableImageInAPI struct {
	value *ImageInAPI
	isSet bool
}

func (v NullableImageInAPI) Get() *ImageInAPI {
	return v.value
}

func (v *NullableImageInAPI) Set(val *ImageInAPI) {
	v.value = val
	v.isSet = true
}

func (v NullableImageInAPI) IsSet() bool {
	return v.isSet
}

func (v *NullableImageInAPI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageInAPI(val *ImageInAPI) *NullableImageInAPI {
	return &NullableImageInAPI{value: val, isSet: true}
}

func (v NullableImageInAPI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageInAPI) UnmarshalJSON(src []byte) error {
	v.isSet = true
