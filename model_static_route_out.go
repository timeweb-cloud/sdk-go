...
// checks if the StaticRouteOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticRouteOut{}

// StaticRouteOut struct for StaticRouteOut
...
func (o StaticRouteOut) MarshalJSON() ([]byte, error) {
...
func (o StaticRouteOut) ToMap() (map[string]interface{}, error) {
...
type NullableStaticRouteOut struct {
	value *StaticRouteOut
	isSet bool
}

func (v NullableStaticRouteOut) Get() *StaticRouteOut {
	return v.value
}

func (v *NullableStaticRouteOut) Set(val *StaticRouteOut) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticRouteOut) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticRouteOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticRouteOut(val *StaticRouteOut) *NullableStaticRouteOut {
	return &NullableStaticRouteOut{value: val, isSet: true}
}

func (v NullableStaticRouteOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticRouteOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
