...
// checks if the CreateBalancerRule200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateBalancerRule200Response{}
...
type NullableCreateBalancerRule200Response struct {
	value *CreateBalancerRule200Response
	isSet bool
}

func (v NullableCreateBalancerRule200Response) Get() *CreateBalancerRule200Response {
	return v.value
}

func (v *NullableCreateBalancerRule200Response) Set(val *CreateBalancerRule200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBalancerRule200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBalancerRule200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBalancerRule200Response(val *CreateBalancerRule200Response) *NullableCreateBalancerRule200Response {
	return &NullableCreateBalancerRule200Response{value: val, isSet: true}
}

func (v NullableCreateBalancerRule200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBalancerRule200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
