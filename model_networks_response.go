...
// checks if the NetworksResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworksResponse{}

// NetworksResponse struct for NetworksResponse
...
// GetRouterNetworks returns the RouterNetworks field value
func (o *NetworksResponse) GetRouterNetworks() []NetworkOut {
	...
	return o.RouterNetworks
}

// GetRouterNetworksOk returns a tuple with the RouterNetworks field value
// and a boolean to check if the value has been set.
func (o *NetworksResponse) GetRouterNetworksOk() ([]NetworkOut, bool) {
	if o == nil {
		return nil, false
	}
	return o.RouterNetworks, true
}

// SetRouterNetworks sets field value
...
func (o NetworksResponse) MarshalJSON() ([]byte, error) {
...
func (o NetworksResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResponseId) {
		toSerialize["response_id"] = o.ResponseId
	}
	toSerialize["router_networks"] = o.RouterNetworks
	toSerialize["meta"] = o.Meta
	return toSerialize, nil
}

type NullableNetworksResponse struct {
	value *NetworksResponse
	isSet bool
}

func (v NullableNetworksResponse) Get() *NetworksResponse {
	return v.value
}

func (v *NullableNetworksResponse) Set(val *NetworksResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksResponse(val *NetworksResponse) *NullableNetworksResponse {
	return &NullableNetworksResponse{value: val, isSet: true}
}

func (v NullableNetworksResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
