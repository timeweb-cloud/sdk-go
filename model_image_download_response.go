...
// checks if the ImageDownloadResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageDownloadResponse{}
...
func (o ImageDownloadResponse) MarshalJSON() ([]byte, error) {
...
func (o ImageDownloadResponse) ToMap() (map[string]interface{}, error) {
...
type NullableImageDownloadResponse struct {
	value *ImageDownloadResponse
	isSet bool
}

func (v NullableImageDownloadResponse) Get() *ImageDownloadResponse {
	return v.value
}

func (v *NullableImageDownloadResponse) Set(val *ImageDownloadResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImageDownloadResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImageDownloadResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageDownloadResponse(val *ImageDownloadResponse) *NullableImageDownloadResponse {
	return &NullableImageDownloadResponse{value: val, isSet: true}
}

func (v NullableImageDownloadResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageDownloadResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
