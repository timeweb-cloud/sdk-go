...
// checks if the UpdateDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateDb{}
...
// GetIsExternalIp returns the IsExternalIp field value if set, zero value otherwise.
func (o *UpdateDb) GetIsExternalIp() bool {
	if o == nil || IsNil(o.IsExternalIp) {
		var ret bool
		return ret
	}
	return *o.IsExternalIp
}

// GetIsExternalIpOk returns a tuple with the IsExternalIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateDb) GetIsExternalIpOk() (*bool, bool) {
	if o == nil || IsNil(o.IsExternalIp) {
		return nil, false
	}
	return o.IsExternalIp, true
}
...
// SetIsExternalIp gets a reference to the given bool and assigns it to the IsExternalIp field.
func (o *UpdateDb) SetIsExternalIp(v bool) {
	o.IsExternalIp = &v
}

func (o UpdateDb) MarshalJSON() ([]byte, error) {
...
func (o UpdateDb) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsExternalIp) {
		toSerialize["is_external_ip"] = o.IsExternalIp
	}
	return toSerialize, nil
}

type NullableUpdateDb struct {
	value *UpdateDb
	isSet bool
}

func (v NullableUpdateDb) Get() *UpdateDb {
	return v.value
}

func (v *NullableUpdateDb) Set(val *UpdateDb) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateDb) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateDb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateDb(val *UpdateDb) *NullableUpdateDb {
	return &NullableUpdateDb{value: val, isSet: true}
}

func (v NullableUpdateDb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateDb) UnmarshalJSON(src []byte) error {
	v.isSet = true
