...
// checks if the ImageOutResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageOutResponse{}
...
func (o ImageOutResponse) MarshalJSON() ([]byte, error) {
...
func (o ImageOutResponse) ToMap() (map[string]interface{}, error) {
...
type NullableImageOutResponse struct {
	value *ImageOutResponse
	isSet bool
}

func (v NullableImageOutResponse) Get() *ImageOutResponse {
	return v.value
}

func (v *NullableImageOutResponse) Set(val *ImageOutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImageOutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImageOutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageOutResponse(val *ImageOutResponse) *NullableImageOutResponse {
	return &NullableImageOutResponse{value: val, isSet: true}
}

func (v NullableImageOutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageOutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
