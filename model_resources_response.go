...
// checks if the ResourcesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourcesResponse{}
...
func (o ResourcesResponse) MarshalJSON() ([]byte, error) {
...
func (o ResourcesResponse) ToMap() (map[string]interface{}, error) {
...
type NullableResourcesResponse struct {
	value *ResourcesResponse
	isSet bool
}

func (v NullableResourcesResponse) Get() *ResourcesResponse {
	return v.value
}

func (v *NullableResourcesResponse) Set(val *ResourcesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResourcesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResourcesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourcesResponse(val *ResourcesResponse) *NullableResourcesResponse {
	return &NullableResourcesResponse{value: val, isSet: true}
}

func (v NullableResourcesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourcesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
