...
// checks if the Free type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Free{}

// Free Обновление заявки на перенос домена
type Free struct {
...
func (o Free) MarshalJSON() ([]byte, error) {
...
func (o Free) ToMap() (map[string]interface{}, error) {
...
type NullableFree struct {
	value *Free
	isSet bool
}

func (v NullableFree) Get() *Free {
	return v.value
}

func (v *NullableFree) Set(val *Free) {
	v.value = val
	v.isSet = true
}

func (v NullableFree) IsSet() bool {
	return v.isSet
}

func (v *NullableFree) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFree(val *Free) *NullableFree {
	return &NullableFree{value: val, isSet: true}
}

func (v NullableFree) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFree) UnmarshalJSON(src []byte) error {
	v.isSet = true
