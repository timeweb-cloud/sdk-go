...
// checks if the RefreshApiKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RefreshApiKey{}

// RefreshApiKey struct for RefreshApiKey
type RefreshApiKey struct {
...
func (o RefreshApiKey) MarshalJSON() ([]byte, error) {
...
func (o RefreshApiKey) ToMap() (map[string]interface{}, error) {
...
type NullableRefreshApiKey struct {
	value *RefreshApiKey
	isSet bool
}

func (v NullableRefreshApiKey) Get() *RefreshApiKey {
	return v.value
}

func (v *NullableRefreshApiKey) Set(val *RefreshApiKey) {
	v.value = val
	v.isSet = true
}

func (v NullableRefreshApiKey) IsSet() bool {
	return v.isSet
}

func (v *NullableRefreshApiKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRefreshApiKey(val *RefreshApiKey) *NullableRefreshApiKey {
	return &NullableRefreshApiKey{value: val, isSet: true}
}

func (v NullableRefreshApiKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRefreshApiKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
