...
type ApiKey struct {
	...
	IsAbleToDelete bool `json:"is_able_to_delete"`
}
...
// GetIsAbleToDelete returns the IsAbleToDelete field value
...
// GetIsAbleToDeleteOk returns a tuple with the IsAbleToDelete field value
// and a boolean to check if the value has been set.
...
// SetIsAbleToDelete sets field value
