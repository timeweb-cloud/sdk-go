...
// checks if the NetworkDrive type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkDrive{}
...
type NetworkDrive struct {
	...
	ServiceList []NetworkDriveServiceListInner `json:"service_list"`
...
// GetServiceList returns the ServiceList field value
func (o *NetworkDrive) GetServiceList() []NetworkDriveServiceListInner {
	if o == nil {
		var ret []NetworkDriveServiceListInner
		return ret
	}
...
// GetServiceListOk returns a tuple with the ServiceList field value
// and a boolean to check if the value has been set.
...
// SetServiceList sets field value
...
func (o NetworkDrive) MarshalJSON() ([]byte, error) {
...
func (o NetworkDrive) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkDrive struct {
	value *NetworkDrive
	isSet bool
}

func (v NullableNetworkDrive) Get() *NetworkDrive {
	return v.value
}

func (v *NullableNetworkDrive) Set(val *NetworkDrive) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkDrive) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkDrive) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkDrive(val *NetworkDrive) *NullableNetworkDrive {
	return &NullableNetworkDrive{value: val, isSet: true}
}

func (v NullableNetworkDrive) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkDrive) UnmarshalJSON(src []byte) error {
	v.isSet = true
