...
// checks if the MailboxAutoReply type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailboxAutoReply{}
...
func (o MailboxAutoReply) MarshalJSON() ([]byte, error) {
...
func (o MailboxAutoReply) ToMap() (map[string]interface{}, error) {
...
type NullableMailboxAutoReply struct {
	value *MailboxAutoReply
	isSet bool
}

func (v NullableMailboxAutoReply) Get() *MailboxAutoReply {
	return v.value
}

func (v *NullableMailboxAutoReply) Set(val *MailboxAutoReply) {
	v.value = val
	v.isSet = true
}

func (v NullableMailboxAutoReply) IsSet() bool {
	return v.isSet
}

func (v *NullableMailboxAutoReply) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailboxAutoReply(val *MailboxAutoReply) *NullableMailboxAutoReply {
	return &NullableMailboxAutoReply{value: val, isSet: true}
}

func (v NullableMailboxAutoReply) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailboxAutoReply) UnmarshalJSON(src []byte) error {
	v.isSet = true
