...
// checks if the RouterResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouterResponse{}

// RouterResponse struct for RouterResponse
...
func (o RouterResponse) MarshalJSON() ([]byte, error) {
...
func (o RouterResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRouterResponse struct {
	value *RouterResponse
	isSet bool
}

func (v NullableRouterResponse) Get() *RouterResponse {
	return v.value
}

func (v *NullableRouterResponse) Set(val *RouterResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRouterResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRouterResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouterResponse(val *RouterResponse) *NullableRouterResponse {
	return &NullableRouterResponse{value: val, isSet: true}
}

func (v NullableRouterResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouterResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
