...
// checks if the CreateAdmin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAdmin{}

// CreateAdmin struct for CreateAdmin
...
func (o CreateAdmin) MarshalJSON() ([]byte, error) {
...
func (o CreateAdmin) ToMap() (map[string]interface{}, error) {
...
type NullableCreateAdmin struct {
	value *CreateAdmin
	isSet bool
}

func (v NullableCreateAdmin) Get() *CreateAdmin {
	return v.value
}

func (v *NullableCreateAdmin) Set(val *CreateAdmin) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAdmin) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAdmin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAdmin(val *CreateAdmin) *NullableCreateAdmin {
	return &NullableCreateAdmin{value: val, isSet: true}
}

func (v NullableCreateAdmin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAdmin) UnmarshalJSON(src []byte) error {
	v.isSet = true
