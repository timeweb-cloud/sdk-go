...
// checks if the NodeGroupsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeGroupsResponse{}
...
func (o NodeGroupsResponse) MarshalJSON() ([]byte, error) {
...
func (o NodeGroupsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNodeGroupsResponse struct {
	value *NodeGroupsResponse
	isSet bool
}

func (v NullableNodeGroupsResponse) Get() *NodeGroupsResponse {
	return v.value
}

func (v *NullableNodeGroupsResponse) Set(val *NodeGroupsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeGroupsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeGroupsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeGroupsResponse(val *NodeGroupsResponse) *NullableNodeGroupsResponse {
	return &NullableNodeGroupsResponse{value: val, isSet: true}
}

func (v NullableNodeGroupsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeGroupsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
