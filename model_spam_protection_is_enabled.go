...
// checks if the SpamProtectionIsEnabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpamProtectionIsEnabled{}

// SpamProtectionIsEnabled struct for SpamProtectionIsEnabled
type SpamProtectionIsEnabled struct {
...
func (o SpamProtectionIsEnabled) MarshalJSON() ([]byte, error) {
...
func (o SpamProtectionIsEnabled) ToMap() (map[string]interface{}, error) {
...
type NullableSpamProtectionIsEnabled struct {
	value *SpamProtectionIsEnabled
	isSet bool
}

func (v NullableSpamProtectionIsEnabled) Get() *SpamProtectionIsEnabled {
	return v.value
}

func (v *NullableSpamProtectionIsEnabled) Set(val *SpamProtectionIsEnabled) {
	v.value = val
	v.isSet = true
}

func (v NullableSpamProtectionIsEnabled) IsSet() bool {
	return v.isSet
}

func (v *NullableSpamProtectionIsEnabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpamProtectionIsEnabled(val *SpamProtectionIsEnabled) *NullableSpamProtectionIsEnabled {
	return &NullableSpamProtectionIsEnabled{value: val, isSet: true}
}

func (v NullableSpamProtectionIsEnabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpamProtectionIsEnabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
