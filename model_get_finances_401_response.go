...
// checks if the GetFinances401Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFinances401Response{}

// GetFinances401Response struct for GetFinances401Response
type GetFinances401Response struct {
	// Короткий идентификатор, соответствующий возвращаемому коду состояния HTTP.
	StatusCode float32 `json:"status_code"`
	Message *GetFinances401ResponseMessage `json:"message,omitempty"`
...
func (o *GetFinances401Response) GetMessage() GetFinances401ResponseMessage {
	if o == nil || IsNil(o.Message) {
		var ret GetFinances401ResponseMessage
		return ret
	}
	return *o.Message
}
...
// SetMessage gets a reference to the given GetFinances401ResponseMessage and assigns it to the Message field.
...
func (o GetFinances401Response) MarshalJSON() ([]byte, error) {
...
func (o GetFinances401Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetFinances401Response struct {
	value *GetFinances401Response
	isSet bool
}

func (v NullableGetFinances401Response) Get() *GetFinances401Response {
	return v.value
}

func (v *NullableGetFinances401Response) Set(val *GetFinances401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFinances401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFinances401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFinances401Response(val *GetFinances401Response) *NullableGetFinances401Response {
	return &NullableGetFinances401Response{value: val, isSet: true}
}

func (v NullableGetFinances401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFinances401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
