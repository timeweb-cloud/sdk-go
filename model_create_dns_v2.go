...
// checks if the CreateDnsV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDnsV2{}

// CreateDnsV2 struct for CreateDnsV2
type CreateDnsV2 struct {
	// Тип DNS-записи.
...
func (o CreateDnsV2) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDnsV2 struct {
	value *CreateDnsV2
	isSet bool
}

func (v NullableCreateDnsV2) Get() *CreateDnsV2 {
	return v.value
}

func (v *NullableCreateDnsV2) Set(val *CreateDnsV2) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDnsV2) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDnsV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDnsV2(val *CreateDnsV2) *NullableCreateDnsV2 {
	return &NullableCreateDnsV2{value: val, isSet: true}
}

func (v NullableCreateDnsV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDnsV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
