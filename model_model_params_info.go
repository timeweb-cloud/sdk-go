...
// checks if the ModelParamsInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelParamsInfo{}

// ModelParamsInfo Информация о доступных параметрах модели с их ограничениями
type ModelParamsInfo struct {
	Temperature *ModelParamsInfoTemperature `json:"temperature,omitempty"`
	MaxTokens *ModelParamsInfoMaxTokens `json:"max_tokens,omitempty"`
	ReasoningEffort *ModelParamsInfoReasoningEffort `json:"reasoning_effort,omitempty"`
}
...
func (o *ModelParamsInfo) GetTemperature() ModelParamsInfoTemperature {
	if o == nil || IsNil(o.Temperature) {
		var ret ModelParamsInfoTemperature
		return ret
	}
...
// SetTemperature gets a reference to the given ModelParamsInfoTemperature and assigns it to the Temperature field.
...
func (o *ModelParamsInfo) GetMaxTokens() ModelParamsInfoMaxTokens {
	if o == nil || IsNil(o.MaxTokens) {
		var ret ModelParamsInfoMaxTokens
		return ret
	}
	return *o.MaxTokens
}
...
// SetMaxTokens gets a reference to the given ModelParamsInfoMaxTokens and assigns it to the MaxTokens field.
...
func (o *ModelParamsInfo) GetReasoningEffort() ModelParamsInfoReasoningEffort {
	if o == nil || IsNil(o.ReasoningEffort) {
		var ret ModelParamsInfoReasoningEffort
		return ret
	}
...
// SetReasoningEffort gets a reference to the given ModelParamsInfoReasoningEffort and assigns it to the ReasoningEffort field.
func (o *ModelParamsInfo) SetReasoningEffort(v ModelParamsInfoReasoningEffort) {
	o.ReasoningEffort = &v
}

func (o ModelParamsInfo) MarshalJSON() ([]byte, error) {
...
func (o ModelParamsInfo) ToMap() (map[string]interface{}, error) {
...
type NullableModelParamsInfo struct {
	value *ModelParamsInfo
	isSet bool
}

func (v NullableModelParamsInfo) Get() *ModelParamsInfo {
	return v.value
}

func (v *NullableModelParamsInfo) Set(val *ModelParamsInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableModelParamsInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableModelParamsInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelParamsInfo(val *ModelParamsInfo) *NullableModelParamsInfo {
	return &NullableModelParamsInfo{value: val, isSet: true}
}

func (v NullableModelParamsInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelParamsInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
