...
// checks if the VdsImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VdsImage{}

// VdsImage Образ сервера.
type VdsImage struct {
	// ID образа сервера.
	Id string `json:"id"`
...
func (o VdsImage) MarshalJSON() ([]byte, error) {
...
func (o VdsImage) ToMap() (map[string]interface{}, error) {
...
type NullableVdsImage struct {
	value *VdsImage
	isSet bool
}

func (v NullableVdsImage) Get() *VdsImage {
	return v.value
}

func (v *NullableVdsImage) Set(val *VdsImage) {
	v.value = val
	v.isSet = true
}

func (v NullableVdsImage) IsSet() bool {
	return v.isSet
}

func (v *NullableVdsImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVdsImage(val *VdsImage) *NullableVdsImage {
	return &NullableVdsImage{value: val, isSet: true}
}

func (v NullableVdsImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVdsImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
