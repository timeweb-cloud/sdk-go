...
// checks if the FirewallGroupResourceOutResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirewallGroupResourceOutResponse{}
...
func (o FirewallGroupResourceOutResponse) MarshalJSON() ([]byte, error) {
...
func (o FirewallGroupResourceOutResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFirewallGroupResourceOutResponse struct {
	value *FirewallGroupResourceOutResponse
	isSet bool
}

func (v NullableFirewallGroupResourceOutResponse) Get() *FirewallGroupResourceOutResponse {
	return v.value
}

func (v *NullableFirewallGroupResourceOutResponse) Set(val *FirewallGroupResourceOutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallGroupResourceOutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallGroupResourceOutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallGroupResourceOutResponse(val *FirewallGroupResourceOutResponse) *NullableFirewallGroupResourceOutResponse {
	return &NullableFirewallGroupResourceOutResponse{value: val, isSet: true}
}

func (v NullableFirewallGroupResourceOutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallGroupResourceOutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
