...
// checks if the UpdateStorageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateStorageRequest{}

// UpdateStorageRequest struct for UpdateStorageRequest
type UpdateStorageRequest struct {
	// ID тарифа.
	PresetId *float32 `json:"preset_id,omitempty"`
	Configurator *UpdateStorageRequestConfigurator `json:"configurator,omitempty"`
	// Тип хранилища.
...
func (o *UpdateStorageRequest) GetConfigurator() UpdateStorageRequestConfigurator {
	if o == nil || IsNil(o.Configurator) {
		var ret UpdateStorageRequestConfigurator
		return ret
	}
...
// SetConfigurator gets a reference to the given UpdateStorageRequestConfigurator and assigns it to the Configurator field.
...
func (o UpdateStorageRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateStorageRequest struct {
	value *UpdateStorageRequest
	isSet bool
}

func (v NullableUpdateStorageRequest) Get() *UpdateStorageRequest {
	return v.value
}

func (v *NullableUpdateStorageRequest) Set(val *UpdateStorageRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateStorageRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateStorageRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateStorageRequest(val *UpdateStorageRequest) *NullableUpdateStorageRequest {
	return &NullableUpdateStorageRequest{value: val, isSet: true}
}

func (v NullableUpdateStorageRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateStorageRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
