...
// Ip Администратор домена — индивидуальный предприниматель
type Ip struct {
	// Тип администратора.
...
// GetInn returns the Inn field value
...
// GetInnOk returns a tuple with the Inn field value
// and a boolean to check if the value has been set.
