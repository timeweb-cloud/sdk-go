...
// checks if the AddBitbucket type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddBitbucket{}

// AddBitbucket Добавление аккаунта Bitbucket
type AddBitbucket struct {
	// Тип провайдера.
...
func (o AddBitbucket) MarshalJSON() ([]byte, error) {
...
func (o AddBitbucket) ToMap() (map[string]interface{}, error) {
...
type NullableAddBitbucket struct {
	value *AddBitbucket
	isSet bool
}

func (v NullableAddBitbucket) Get() *AddBitbucket {
	return v.value
}

func (v *NullableAddBitbucket) Set(val *AddBitbucket) {
	v.value = val
	v.isSet = true
}

func (v NullableAddBitbucket) IsSet() bool {
	return v.isSet
}

func (v *NullableAddBitbucket) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddBitbucket(val *AddBitbucket) *NullableAddBitbucket {
	return &NullableAddBitbucket{value: val, isSet: true}
}

func (v NullableAddBitbucket) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddBitbucket) UnmarshalJSON(src []byte) error {
	v.isSet = true
