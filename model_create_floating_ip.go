...
// checks if the CreateFloatingIp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFloatingIp{}

// CreateFloatingIp struct for CreateFloatingIp
...
func (o CreateFloatingIp) MarshalJSON() ([]byte, error) {
...
func (o CreateFloatingIp) ToMap() (map[string]interface{}, error) {
...
type NullableCreateFloatingIp struct {
	value *CreateFloatingIp
	isSet bool
}

func (v NullableCreateFloatingIp) Get() *CreateFloatingIp {
	return v.value
}

func (v *NullableCreateFloatingIp) Set(val *CreateFloatingIp) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFloatingIp) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFloatingIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFloatingIp(val *CreateFloatingIp) *NullableCreateFloatingIp {
	return &NullableCreateFloatingIp{value: val, isSet: true}
}

func (v NullableCreateFloatingIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFloatingIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
