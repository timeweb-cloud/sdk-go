...
// checks if the ClusterInMaintenanceSlot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterInMaintenanceSlot{}

// ClusterInMaintenanceSlot Окно обслуживания кластера
type ClusterInMaintenanceSlot struct {
...
func (o ClusterInMaintenanceSlot) MarshalJSON() ([]byte, error) {
...
func (o ClusterInMaintenanceSlot) ToMap() (map[string]interface{}, error) {
...
type NullableClusterInMaintenanceSlot struct {
	value *ClusterInMaintenanceSlot
	isSet bool
}

func (v NullableClusterInMaintenanceSlot) Get() *ClusterInMaintenanceSlot {
	return v.value
}

func (v *NullableClusterInMaintenanceSlot) Set(val *ClusterInMaintenanceSlot) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterInMaintenanceSlot) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterInMaintenanceSlot) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterInMaintenanceSlot(val *ClusterInMaintenanceSlot) *NullableClusterInMaintenanceSlot {
	return &NullableClusterInMaintenanceSlot{value: val, isSet: true}
}

func (v NullableClusterInMaintenanceSlot) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterInMaintenanceSlot) UnmarshalJSON(src []byte) error {
	v.isSet = true
