...
// checks if the GetClusters200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetClusters200Response{}
...
func (o GetClusters200Response) ToMap() (map[string]interface{}, error) {
