...
// checks if the AutoBackup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoBackup{}

// AutoBackup struct for AutoBackup
...
// SetCopyCount gets a reference to the given float32 and assigns it to the CopyCount field.
func (o *AutoBackup) SetCopyCount(v float32) {
	o.CopyCount = &v
}

// GetCreationStartAt returns the CreationStartAt field value if set, zero value otherwise.
func (o *AutoBackup) GetCreationStartAt() time.Time {
	if o == nil || IsNil(o.CreationStartAt) {
		var ret time.Time
		return ret
	}
...
// GetCreationStartAtOk returns a tuple with the CreationStartAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetCreationStartAt gets a reference to the given time.Time and assigns it to the CreationStartAt field.
...
func (o AutoBackup) MarshalJSON() ([]byte, error) {
...
func (o AutoBackup) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CopyCount) {
		toSerialize["copy_count"] = o.CopyCount
	}
	if !IsNil(o.CreationStartAt) {
...
type NullableAutoBackup struct {
	value *AutoBackup
	isSet bool
}

func (v NullableAutoBackup) Get() *AutoBackup {
	return v.value
}

func (v *NullableAutoBackup) Set(val *AutoBackup) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoBackup) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoBackup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoBackup(val *AutoBackup) *NullableAutoBackup {
	return &NullableAutoBackup{value: val, isSet: true}
}

func (v NullableAutoBackup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoBackup) UnmarshalJSON(src []byte) error {
	v.isSet = true
