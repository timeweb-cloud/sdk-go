...
// checks if the GetStorageTransferStatus200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetStorageTransferStatus200Response{}
...
type NullableGetStorageTransferStatus200Response struct {
	value *GetStorageTransferStatus200Response
	isSet bool
}

func (v NullableGetStorageTransferStatus200Response) Get() *GetStorageTransferStatus200Response {
	return v.value
}

func (v *NullableGetStorageTransferStatus200Response) Set(val *GetStorageTransferStatus200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetStorageTransferStatus200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetStorageTransferStatus200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetStorageTransferStatus200Response(val *GetStorageTransferStatus200Response) *NullableGetStorageTransferStatus200Response {
	return &NullableGetStorageTransferStatus200Response{value: val, isSet: true}
}

func (v NullableGetStorageTransferStatus200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetStorageTransferStatus200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
