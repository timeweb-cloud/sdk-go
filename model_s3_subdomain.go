...
// checks if the S3Subdomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &S3Subdomain{}
...
// GetCertReleased returns the CertReleased field value
func (o *S3Subdomain) GetCertReleased() time.Time {
	...
	return o.CertReleased
}

// GetCertReleasedOk returns a tuple with the CertReleased field value
// and a boolean to check if the value has been set.
func (o *S3Subdomain) GetCertReleasedOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CertReleased, true
}

// SetCertReleased sets field value
...
func (o S3Subdomain) MarshalJSON() ([]byte, error) {
...
func (o S3Subdomain) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["subdomain"] = o.Subdomain
	toSerialize["cert_released"] = o.CertReleased
	toSerialize["tries"] = o.Tries
	toSerialize["status"] = o.Status
	return toSerialize, nil
}

type NullableS3Subdomain struct {
	value *S3Subdomain
	isSet bool
}

func (v NullableS3Subdomain) Get() *S3Subdomain {
	return v.value
}

func (v *NullableS3Subdomain) Set(val *S3Subdomain) {
	v.value = val
	v.isSet = true
}

func (v NullableS3Subdomain) IsSet() bool {
	return v.isSet
}

func (v *NullableS3Subdomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableS3Subdomain(val *S3Subdomain) *NullableS3Subdomain {
	return &NullableS3Subdomain{value: val, isSet: true}
}

func (v NullableS3Subdomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableS3Subdomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
