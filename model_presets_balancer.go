...
// checks if the PresetsBalancer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PresetsBalancer{}

// PresetsBalancer struct for PresetsBalancer
type PresetsBalancer struct {
	...
	// Количество реплик.
	ReplicaCount float32 `json:"replica_count"`
	// Запросов в секунду.
	RequestPerSecond string `json:"request_per_second"`
...
// GetRequestPerSecond returns the RequestPerSecond field value
func (o *PresetsBalancer) GetRequestPerSecond() string {
	...
	return o.RequestPerSecond
}

// GetRequestPerSecondOk returns a tuple with the RequestPerSecond field value
// and a boolean to check if the value has been set.
func (o *PresetsBalancer) GetRequestPerSecondOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RequestPerSecond, true
}

// SetRequestPerSecond sets field value
func (o *PresetsBalancer) SetRequestPerSecond(v string) {
	o.RequestPerSecond = v
}
...
func (o PresetsBalancer) MarshalJSON() ([]byte, error) {
...
func (o PresetsBalancer) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["request_per_second"] = o.RequestPerSecond
	toSerialize["price"] = o.Price
	toSerialize["location"] = o.Location
	return toSerialize, nil
}

type NullablePresetsBalancer struct {
	value *PresetsBalancer
	isSet bool
}

func (v NullablePresetsBalancer) Get() *PresetsBalancer {
	return v.value
}

func (v *NullablePresetsBalancer) Set(val *PresetsBalancer) {
	v.value = val
	v.isSet = true
}

func (v NullablePresetsBalancer) IsSet() bool {
	return v.isSet
}

func (v *NullablePresetsBalancer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePresetsBalancer(val *PresetsBalancer) *NullablePresetsBalancer {
	return &NullablePresetsBalancer{value: val, isSet: true}
}

func (v NullablePresetsBalancer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePresetsBalancer) UnmarshalJSON(src []byte) error {
	v.isSet = true
