...
// checks if the RouterOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouterOut{}

// RouterOut struct for RouterOut
type RouterOut struct {
	...
	// IP-адреса
	Ips []RouterOutIpsInner `json:"ips"`
	// ID тарифа
	PresetId int32 `json:"preset_id"`
	Preset RouterPreset `json:"preset"`
	// Ноды
	Nodes []RouterOutNodesInner `json:"nodes"`
	// Сети
	...
	ParentServices []RouterOutParentServicesInner `json:"parent_services"`
}
...
// GetParentServices returns the ParentServices field value
func (o *RouterOut) GetParentServices() []RouterOutParentServicesInner {
	if o == nil {
		var ret []RouterOutParentServicesInner
		return ret
	}

	return o.ParentServices
}

// GetParentServicesOk returns a tuple with the ParentServices field value
// and a boolean to check if the value has been set.
func (o *RouterOut) GetParentServicesOk() ([]RouterOutParentServicesInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.ParentServices, true
}

// SetParentServices sets field value
func (o *RouterOut) SetParentServices(v []RouterOutParentServicesInner) {
	o.ParentServices = v
}

func (o RouterOut) MarshalJSON() ([]byte, error) {
...
func (o RouterOut) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["parent_services"] = o.ParentServices
	return toSerialize, nil
}

type NullableRouterOut struct {
	value *RouterOut
	isSet bool
}

func (v NullableRouterOut) Get() *RouterOut {
	return v.value
}

func (v *NullableRouterOut) Set(val *RouterOut) {
	v.value = val
	v.isSet = true
}

func (v NullableRouterOut) IsSet() bool {
	return v.isSet
}

func (v *NullableRouterOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouterOut(val *RouterOut) *NullableRouterOut {
	return &NullableRouterOut{value: val, isSet: true}
}

func (v NullableRouterOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouterOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
