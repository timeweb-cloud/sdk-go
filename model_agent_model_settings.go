...
// checks if the AgentModelSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentModelSettings{}
...
func (o AgentModelSettings) MarshalJSON() ([]byte, error) {
...
func (o AgentModelSettings) ToMap() (map[string]interface{}, error) {
...
type NullableAgentModelSettings struct {
	value *AgentModelSettings
	isSet bool
}

func (v NullableAgentModelSettings) Get() *AgentModelSettings {
	return v.value
}

func (v *NullableAgentModelSettings) Set(val *AgentModelSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentModelSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentModelSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentModelSettings(val *AgentModelSettings) *NullableAgentModelSettings {
	return &NullableAgentModelSettings{value: val, isSet: true}
}

func (v NullableAgentModelSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentModelSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
