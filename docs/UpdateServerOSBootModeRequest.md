...
------------ | ------------- | ------------- | -------------
**BootMode** | **string** | Тип загрузки операционной системы. \\  Параметры: &#x60;default&#x60; – стандартный режим, &#x60;single&#x60; – однопользовательский режим (**deprecated**, оставлен для обратной совместимости, выбор недоступен), &#x60;recovery_disk&#x60; – загрузка с диска восстановления. | 
