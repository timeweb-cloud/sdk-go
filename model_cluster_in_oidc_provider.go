...
// checks if the ClusterInOidcProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterInOidcProvider{}

// ClusterInOidcProvider OIDC-провайдер
type ClusterInOidcProvider struct {
...
func (o ClusterInOidcProvider) MarshalJSON() ([]byte, error) {
...
func (o ClusterInOidcProvider) ToMap() (map[string]interface{}, error) {
...
type NullableClusterInOidcProvider struct {
	value *ClusterInOidcProvider
	isSet bool
}

func (v NullableClusterInOidcProvider) Get() *ClusterInOidcProvider {
	return v.value
}

func (v *NullableClusterInOidcProvider) Set(val *ClusterInOidcProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterInOidcProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterInOidcProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterInOidcProvider(val *ClusterInOidcProvider) *NullableClusterInOidcProvider {
	return &NullableClusterInOidcProvider{value: val, isSet: true}
}

func (v NullableClusterInOidcProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterInOidcProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true
