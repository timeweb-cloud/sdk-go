...
// checks if the AddedSubdomain type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddedSubdomain{}
...
func (o AddedSubdomain) MarshalJSON() ([]byte, error) {
...
func (o AddedSubdomain) ToMap() (map[string]interface{}, error) {
...
type NullableAddedSubdomain struct {
	value *AddedSubdomain
	isSet bool
}

func (v NullableAddedSubdomain) Get() *AddedSubdomain {
	return v.value
}

func (v *NullableAddedSubdomain) Set(val *AddedSubdomain) {
	v.value = val
	v.isSet = true
}

func (v NullableAddedSubdomain) IsSet() bool {
	return v.isSet
}

func (v *NullableAddedSubdomain) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddedSubdomain(val *AddedSubdomain) *NullableAddedSubdomain {
	return &NullableAddedSubdomain{value: val, isSet: true}
}

func (v NullableAddedSubdomain) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddedSubdomain) UnmarshalJSON(src []byte) error {
	v.isSet = true
