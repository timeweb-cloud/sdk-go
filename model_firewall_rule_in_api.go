...
// checks if the FirewallRuleInAPI type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirewallRuleInAPI{}
...
func (o FirewallRuleInAPI) MarshalJSON() ([]byte, error) {
...
func (o FirewallRuleInAPI) ToMap() (map[string]interface{}, error) {
...
type NullableFirewallRuleInAPI struct {
	value *FirewallRuleInAPI
	isSet bool
}

func (v NullableFirewallRuleInAPI) Get() *FirewallRuleInAPI {
	return v.value
}

func (v *NullableFirewallRuleInAPI) Set(val *FirewallRuleInAPI) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallRuleInAPI) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallRuleInAPI) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallRuleInAPI(val *FirewallRuleInAPI) *NullableFirewallRuleInAPI {
	return &NullableFirewallRuleInAPI{value: val, isSet: true}
}

func (v NullableFirewallRuleInAPI) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallRuleInAPI) UnmarshalJSON(src []byte) error {
	v.isSet = true
