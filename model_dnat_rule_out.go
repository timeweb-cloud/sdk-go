...
// checks if the DnatRuleOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DnatRuleOut{}

// DnatRuleOut struct for DnatRuleOut
type DnatRuleOut struct {
	...
	LocalPort NullableString `json:"local_port"`
	// Публичный IP-адрес
	PublicIp string `json:"public_ip"`
	// Внешний порт или диапазон
	PublicPort NullableString `json:"public_port"`
	// Протокол
...
func (o DnatRuleOut) MarshalJSON() ([]byte, error) {
...
func (o DnatRuleOut) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["local_ip"] = o.LocalIp
	toSerialize["local_port"] = o.LocalPort.Get()
	toSerialize["public_ip"] = o.PublicIp
	toSerialize["public_port"] = o.PublicPort.Get()
	toSerialize["protocol"] = o.Protocol
	return toSerialize, nil
}

type NullableDnatRuleOut struct {
	value *DnatRuleOut
	isSet bool
}

func (v NullableDnatRuleOut) Get() *DnatRuleOut {
	return v.value
}

func (v *NullableDnatRuleOut) Set(val *DnatRuleOut) {
	v.value = val
	v.isSet = true
}

func (v NullableDnatRuleOut) IsSet() bool {
	return v.isSet
}

func (v *NullableDnatRuleOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDnatRuleOut(val *DnatRuleOut) *NullableDnatRuleOut {
	return &NullableDnatRuleOut{value: val, isSet: true}
}

func (v NullableDnatRuleOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDnatRuleOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
