...
type AppDiskStatus struct {
	...
	// ID диска.
	DiskId *float32 `json:"disk_id,omitempty"`
}
...
// SetDiskId gets a reference to the given float32 and assigns it to the DiskId field.
func (o *AppDiskStatus) SetDiskId(v float32) {
	o.DiskId = &v
}

func (o AppDiskStatus) MarshalJSON() ([]byte, error) {
...
func (o AppDiskStatus) ToMap() (map[string]interface{}, error) {
...
type NullableAppDiskStatus struct {
	value *AppDiskStatus
	isSet bool
}

func (v NullableAppDiskStatus) Get() *AppDiskStatus {
	return v.value
}

func (v *NullableAppDiskStatus) Set(val *AppDiskStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAppDiskStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAppDiskStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppDiskStatus(val *AppDiskStatus) *NullableAppDiskStatus {
	return &NullableAppDiskStatus{value: val, isSet: true}
}

func (v NullableAppDiskStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppDiskStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
