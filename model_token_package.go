...
// checks if the TokenPackage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenPackage{}
...
type TokenPackage struct {
	...
	DurationDays NullableFloat32 `json:"duration_days,omitempty"`
...
func (o *TokenPackage) SetDurationDaysNil() {
...
func (o TokenPackage) MarshalJSON() ([]byte, error) {
...
func (o TokenPackage) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["token_amount"] = o.TokenAmount
...
type NullableTokenPackage struct {
	value *TokenPackage
	isSet bool
}

func (v NullableTokenPackage) Get() *TokenPackage {
	return v.value
}

func (v *NullableTokenPackage) Set(val *TokenPackage) {
	v.value = val
	v.isSet = true
}

func (v NullableTokenPackage) IsSet() bool {
	return v.isSet
}

func (v *NullableTokenPackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTokenPackage(val *TokenPackage) *NullableTokenPackage {
	return &NullableTokenPackage{value: val, isSet: true}
}

func (v NullableTokenPackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTokenPackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
