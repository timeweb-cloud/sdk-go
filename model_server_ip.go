...
// checks if the ServerIp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerIp{}
...
func (o ServerIp) MarshalJSON() ([]byte, error) {
...
func (o ServerIp) ToMap() (map[string]interface{}, error) {
...
type NullableServerIp struct {
	value *ServerIp
	isSet bool
}

func (v NullableServerIp) Get() *ServerIp {
	return v.value
}

func (v *NullableServerIp) Set(val *ServerIp) {
	v.value = val
	v.isSet = true
}

func (v NullableServerIp) IsSet() bool {
	return v.isSet
}

func (v *NullableServerIp) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerIp(val *ServerIp) *NullableServerIp {
	return &NullableServerIp{value: val, isSet: true}
}

func (v NullableServerIp) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerIp) UnmarshalJSON(src []byte) error {
	v.isSet = true
