...
type CreateDedicatedServer struct {
	...
	BandwidthId *float32 `json:"bandwidth_id,omitempty"`
...
// GetBandwidthId returns the BandwidthId field value if set, zero value otherwise.
func (o *CreateDedicatedServer) GetBandwidthId() float32 {
	if o == nil || IsNil(o.BandwidthId) {
		var ret float32
		return ret
	}
	return *o.BandwidthId
}
...
// SetBandwidthId gets a reference to the given float32 and assigns it to the BandwidthId field.
...
func (o CreateDedicatedServer) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BandwidthId) {
		toSerialize["bandwidth_id"] = o.BandwidthId
	}
