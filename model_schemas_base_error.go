...
// checks if the SchemasBaseError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemasBaseError{}

// SchemasBaseError struct for SchemasBaseError
...
func (o SchemasBaseError) MarshalJSON() ([]byte, error) {
...
func (o SchemasBaseError) ToMap() (map[string]interface{}, error) {
...
type NullableSchemasBaseError struct {
	value *SchemasBaseError
	isSet bool
}

func (v NullableSchemasBaseError) Get() *SchemasBaseError {
	return v.value
}

func (v *NullableSchemasBaseError) Set(val *SchemasBaseError) {
	v.value = val
	v.isSet = true
}

func (v NullableSchemasBaseError) IsSet() bool {
	return v.isSet
}

func (v *NullableSchemasBaseError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchemasBaseError(val *SchemasBaseError) *NullableSchemasBaseError {
	return &NullableSchemasBaseError{value: val, isSet: true}
}

func (v NullableSchemasBaseError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchemasBaseError) UnmarshalJSON(src []byte) error {
	v.isSet = true
