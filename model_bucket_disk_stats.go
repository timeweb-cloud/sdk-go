...
// checks if the BucketDiskStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BucketDiskStats{}
...
func (o BucketDiskStats) ToMap() (map[string]interface{}, error) {
...
type NullableBucketDiskStats struct {
	value *BucketDiskStats
	isSet bool
}

func (v NullableBucketDiskStats) Get() *BucketDiskStats {
	return v.value
}

func (v *NullableBucketDiskStats) Set(val *BucketDiskStats) {
	v.value = val
	v.isSet = true
}

func (v NullableBucketDiskStats) IsSet() bool {
	return v.isSet
}

func (v *NullableBucketDiskStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBucketDiskStats(val *BucketDiskStats) *NullableBucketDiskStats {
	return &NullableBucketDiskStats{value: val, isSet: true}
}

func (v NullableBucketDiskStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBucketDiskStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
