...
// GetContainerRegistryList returns the ContainerRegistryList field value if set, zero value otherwise.
func (o *RegistriesResponse) GetContainerRegistryList() []RegistryOut {
	if o == nil || IsNil(o.ContainerRegistryList) {
		var ret []RegistryOut
		return ret
	}
	return o.ContainerRegistryList
}

// GetContainerRegistryListOk returns a tuple with the ContainerRegistryList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RegistriesResponse) GetContainerRegistryListOk() ([]RegistryOut, bool) {
	if o == nil || IsNil(o.ContainerRegistryList) {
		return nil, false
	}
	return o.ContainerRegistryList, true
}
...
// SetContainerRegistryList gets a reference to the given []RegistryOut and assigns it to the ContainerRegistryList field.
func (o *RegistriesResponse) SetContainerRegistryList(v []RegistryOut) {
	o.ContainerRegistryList = v
}
...
func (o RegistriesResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ContainerRegistryList) {
		toSerialize["container_registry_list"] = o.ContainerRegistryList
	}
