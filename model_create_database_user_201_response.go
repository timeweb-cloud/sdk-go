...
// checks if the CreateDatabaseUser201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDatabaseUser201Response{}
...
type NullableCreateDatabaseUser201Response struct {
	value *CreateDatabaseUser201Response
	isSet bool
}

func (v NullableCreateDatabaseUser201Response) Get() *CreateDatabaseUser201Response {
	return v.value
}

func (v *NullableCreateDatabaseUser201Response) Set(val *CreateDatabaseUser201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDatabaseUser201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDatabaseUser201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDatabaseUser201Response(val *CreateDatabaseUser201Response) *NullableCreateDatabaseUser201Response {
	return &NullableCreateDatabaseUser201Response{value: val, isSet: true}
}

func (v NullableCreateDatabaseUser201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDatabaseUser201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
