...
func (o VdsSoftware) MarshalJSON() ([]byte, error) {
...
func (o VdsSoftware) ToMap() (map[string]interface{}, error) {
...
type NullableVdsSoftware struct {
	value *VdsSoftware
	isSet bool
}

func (v NullableVdsSoftware) Get() *VdsSoftware {
	return v.value
}

func (v *NullableVdsSoftware) Set(val *VdsSoftware) {
	v.value = val
	v.isSet = true
}

func (v NullableVdsSoftware) IsSet() bool {
	return v.isSet
}

func (v *NullableVdsSoftware) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVdsSoftware(val *VdsSoftware) *NullableVdsSoftware {
	return &NullableVdsSoftware{value: val, isSet: true}
}

func (v NullableVdsSoftware) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVdsSoftware) UnmarshalJSON(src []byte) error {
	v.isSet = true
