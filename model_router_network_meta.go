...
// checks if the RouterNetworkMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouterNetworkMeta{}

// RouterNetworkMeta struct for RouterNetworkMeta
...
func (o RouterNetworkMeta) MarshalJSON() ([]byte, error) {
...
func (o RouterNetworkMeta) ToMap() (map[string]interface{}, error) {
...
type NullableRouterNetworkMeta struct {
	value *RouterNetworkMeta
	isSet bool
}

func (v NullableRouterNetworkMeta) Get() *RouterNetworkMeta {
	return v.value
}

func (v *NullableRouterNetworkMeta) Set(val *RouterNetworkMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableRouterNetworkMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableRouterNetworkMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouterNetworkMeta(val *RouterNetworkMeta) *NullableRouterNetworkMeta {
	return &NullableRouterNetworkMeta{value: val, isSet: true}
}

func (v NullableRouterNetworkMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouterNetworkMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true
