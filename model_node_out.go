...
// checks if the NodeOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeOut{}

// NodeOut struct for NodeOut
type NodeOut struct {
	// ID ноды
	Id int32 `json:"id"`
...
func (o NodeOut) ToMap() (map[string]interface{}, error) {
...
type NullableNodeOut struct {
	value *NodeOut
	isSet bool
}

func (v NullableNodeOut) Get() *NodeOut {
	return v.value
}

func (v *NullableNodeOut) Set(val *NodeOut) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeOut) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeOut(val *NodeOut) *NullableNodeOut {
	return &NullableNodeOut{value: val, isSet: true}
}

func (v NullableNodeOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
