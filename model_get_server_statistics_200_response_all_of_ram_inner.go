...
// checks if the GetServerStatistics200ResponseAllOfRamInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerStatistics200ResponseAllOfRamInner{}

// GetServerStatistics200ResponseAllOfRamInner struct for GetServerStatistics200ResponseAllOfRamInner
type GetServerStatistics200ResponseAllOfRamInner struct {
...
func NewGetServerStatistics200ResponseAllOfRamInner(loggedAt time.Time, total float32, used float32, usedCached float32, available float32) *GetServerStatistics200ResponseAllOfRamInner {
	this := GetServerStatistics200ResponseAllOfRamInner{}
...
// GetUsedCached returns the UsedCached field value
...
// GetUsedCachedOk returns a tuple with the UsedCached field value
// and a boolean to check if the value has been set.
func (o *GetServerStatistics200ResponseAllOfRamInner) GetUsedCachedOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UsedCached, true
}

// SetUsedCached sets field value
...
func (o GetServerStatistics200ResponseAllOfRamInner) MarshalJSON() ([]byte, error) {
...
func (o GetServerStatistics200ResponseAllOfRamInner) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["logged_at"] = o.LoggedAt
	toSerialize["total"] = o.Total
	toSerialize["used"] = o.Used
	toSerialize["used_cached"] = o.UsedCached
	toSerialize["available"] = o.Available
	return toSerialize, nil
}

type NullableGetServerStatistics200ResponseAllOfRamInner struct {
	value *GetServerStatistics200ResponseAllOfRamInner
	isSet bool
}

func (v NullableGetServerStatistics200ResponseAllOfRamInner) Get() *GetServerStatistics200ResponseAllOfRamInner {
	return v.value
}

func (v *NullableGetServerStatistics200ResponseAllOfRamInner) Set(val *GetServerStatistics200ResponseAllOfRamInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerStatistics200ResponseAllOfRamInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerStatistics200ResponseAllOfRamInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerStatistics200ResponseAllOfRamInner(val *GetServerStatistics200ResponseAllOfRamInner) *NullableGetServerStatistics200ResponseAllOfRamInner {
	return &NullableGetServerStatistics200ResponseAllOfRamInner{value: val, isSet: true}
}

func (v NullableGetServerStatistics200ResponseAllOfRamInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerStatistics200ResponseAllOfRamInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
