...
// checks if the ServersOs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServersOs{}

// ServersOs struct for ServersOs
type ServersOs struct {
	...
	Requirements *ServersOsRequirements `json:"requirements,omitempty"`
}
...
// GetVersionCodename returns the VersionCodename field value if set, zero value otherwise.
func (o *ServersOs) GetVersionCodename() string {
	if o == nil || IsNil(o.VersionCodename) {
		var ret string
		return ret
	}
	return *o.VersionCodename
}

// GetVersionCodenameOk returns a tuple with the VersionCodename field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServersOs) GetVersionCodenameOk() (*string, bool) {
	if o == nil || IsNil(o.VersionCodename) {
		return nil, false
	}
	return o.VersionCodename, true
}
...
// SetVersionCodename gets a reference to the given string and assigns it to the VersionCodename field.
...
// SetRequirements gets a reference to the given ServersOsRequirements and assigns it to the Requirements field.
func (o *ServersOs) SetRequirements(v ServersOsRequirements) {
	o.Requirements = &v
}

func (o ServersOs) MarshalJSON() ([]byte, error) {
...
func (o ServersOs) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.VersionCodename) {
		toSerialize["version_codename"] = o.VersionCodename
	}
...
type NullableServersOs struct {
	value *ServersOs
	isSet bool
}

func (v NullableServersOs) Get() *ServersOs {
	return v.value
}

func (v *NullableServersOs) Set(val *ServersOs) {
	v.value = val
	v.isSet = true
}

func (v NullableServersOs) IsSet() bool {
	return v.isSet
}

func (v *NullableServersOs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServersOs(val *ServersOs) *NullableServersOs {
	return &NullableServersOs{value: val, isSet: true}
}

func (v NullableServersOs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServersOs) UnmarshalJSON(src []byte) error {
	v.isSet = true
