...
// SetCores gets a reference to the given Resource and assigns it to the Cores field.
...
// SetMemory gets a reference to the given Resource and assigns it to the Memory field.
...
// SetPods gets a reference to the given Resource and assigns it to the Pods field.
