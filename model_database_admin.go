...
// checks if the DatabaseAdmin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DatabaseAdmin{}

// DatabaseAdmin Пользователь базы данных
type DatabaseAdmin struct {
	...
	Instances []DatabaseAdminInstancesInner `json:"instances"`
}
...
func (o *DatabaseAdmin) GetInstances() []DatabaseAdminInstancesInner {
	if o == nil {
		var ret []DatabaseAdminInstancesInner
		return ret
	}
...
func (o DatabaseAdmin) MarshalJSON() ([]byte, error) {
...
func (o DatabaseAdmin) ToMap() (map[string]interface{}, error) {
...
type NullableDatabaseAdmin struct {
	value *DatabaseAdmin
	isSet bool
}

func (v NullableDatabaseAdmin) Get() *DatabaseAdmin {
	return v.value
}

func (v *NullableDatabaseAdmin) Set(val *DatabaseAdmin) {
	v.value = val
	v.isSet = true
}

func (v NullableDatabaseAdmin) IsSet() bool {
	return v.isSet
}

func (v *NullableDatabaseAdmin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatabaseAdmin(val *DatabaseAdmin) *NullableDatabaseAdmin {
	return &NullableDatabaseAdmin{value: val, isSet: true}
}

func (v NullableDatabaseAdmin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatabaseAdmin) UnmarshalJSON(src []byte) error {
	v.isSet = true
