...
// checks if the ServerBackup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerBackup{}

// ServerBackup struct for ServerBackup
...
func (o ServerBackup) MarshalJSON() ([]byte, error) {
...
func (o ServerBackup) ToMap() (map[string]interface{}, error) {
...
type NullableServerBackup struct {
	value *ServerBackup
	isSet bool
}

func (v NullableServerBackup) Get() *ServerBackup {
	return v.value
}

func (v *NullableServerBackup) Set(val *ServerBackup) {
	v.value = val
	v.isSet = true
}

func (v NullableServerBackup) IsSet() bool {
	return v.isSet
}

func (v *NullableServerBackup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerBackup(val *ServerBackup) *NullableServerBackup {
	return &NullableServerBackup{value: val, isSet: true}
}

func (v NullableServerBackup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerBackup) UnmarshalJSON(src []byte) error {
	v.isSet = true
