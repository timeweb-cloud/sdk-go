...
// checks if the AddServerIPRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddServerIPRequest{}

// AddServerIPRequest struct for AddServerIPRequest
type AddServerIPRequest struct {
	// Тип IP-адреса
...
func (o AddServerIPRequest) MarshalJSON() ([]byte, error) {
...
func (o AddServerIPRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAddServerIPRequest struct {
	value *AddServerIPRequest
	isSet bool
}

func (v NullableAddServerIPRequest) Get() *AddServerIPRequest {
	return v.value
}

func (v *NullableAddServerIPRequest) Set(val *AddServerIPRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddServerIPRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddServerIPRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddServerIPRequest(val *AddServerIPRequest) *NullableAddServerIPRequest {
	return &NullableAddServerIPRequest{value: val, isSet: true}
}

func (v NullableAddServerIPRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddServerIPRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
