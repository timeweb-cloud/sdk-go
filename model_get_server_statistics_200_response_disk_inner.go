...
// checks if the GetServerStatistics200ResponseDiskInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServerStatistics200ResponseDiskInner{}

// GetServerStatistics200ResponseDiskInner struct for GetServerStatistics200ResponseDiskInner
type GetServerStatistics200ResponseDiskInner struct {
...
func NewGetServerStatistics200ResponseDiskInner(loggedAt time.Time, write float32, read float32) *GetServerStatistics200ResponseDiskInner {
	this := GetServerStatistics200ResponseDiskInner{}
...
func (o GetServerStatistics200ResponseDiskInner) MarshalJSON() ([]byte, error) {
...
func (o GetServerStatistics200ResponseDiskInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetServerStatistics200ResponseDiskInner struct {
	value *GetServerStatistics200ResponseDiskInner
	isSet bool
}

func (v NullableGetServerStatistics200ResponseDiskInner) Get() *GetServerStatistics200ResponseDiskInner {
	return v.value
}

func (v *NullableGetServerStatistics200ResponseDiskInner) Set(val *GetServerStatistics200ResponseDiskInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServerStatistics200ResponseDiskInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServerStatistics200ResponseDiskInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServerStatistics200ResponseDiskInner(val *GetServerStatistics200ResponseDiskInner) *NullableGetServerStatistics200ResponseDiskInner {
	return &NullableGetServerStatistics200ResponseDiskInner{value: val, isSet: true}
}

func (v NullableGetServerStatistics200ResponseDiskInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServerStatistics200ResponseDiskInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
