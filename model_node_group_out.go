...
// checks if the NodeGroupOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeGroupOut{}

// NodeGroupOut struct for NodeGroupOut
...
func (o NodeGroupOut) MarshalJSON() ([]byte, error) {
...
func (o NodeGroupOut) ToMap() (map[string]interface{}, error) {
...
type NullableNodeGroupOut struct {
	value *NodeGroupOut
	isSet bool
}

func (v NullableNodeGroupOut) Get() *NodeGroupOut {
	return v.value
}

func (v *NullableNodeGroupOut) Set(val *NodeGroupOut) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeGroupOut) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeGroupOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeGroupOut(val *NodeGroupOut) *NullableNodeGroupOut {
	return &NullableNodeGroupOut{value: val, isSet: true}
}

func (v NullableNodeGroupOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeGroupOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
