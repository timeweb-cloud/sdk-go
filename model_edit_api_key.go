...
// checks if the EditApiKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditApiKey{}

// EditApiKey struct for EditApiKey
...
func (o EditApiKey) MarshalJSON() ([]byte, error) {
...
func (o EditApiKey) ToMap() (map[string]interface{}, error) {
...
type NullableEditApiKey struct {
	value *EditApiKey
	isSet bool
}

func (v NullableEditApiKey) Get() *EditApiKey {
	return v.value
}

func (v *NullableEditApiKey) Set(val *EditApiKey) {
	v.value = val
	v.isSet = true
}

func (v NullableEditApiKey) IsSet() bool {
	return v.isSet
}

func (v *NullableEditApiKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditApiKey(val *EditApiKey) *NullableEditApiKey {
	return &NullableEditApiKey{value: val, isSet: true}
}

func (v NullableEditApiKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditApiKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
