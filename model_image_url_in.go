...
// checks if the ImageUrlIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageUrlIn{}
...
// SetType gets a reference to the given URLType and assigns it to the Type field.
...
// SetAuth gets a reference to the given ImageUrlAuth and assigns it to the Auth field.
func (o *ImageUrlIn) SetAuth(v ImageUrlAuth) {
	o.Auth = &v
}

func (o ImageUrlIn) MarshalJSON() ([]byte, error) {
...
func (o ImageUrlIn) ToMap() (map[string]interface{}, error) {
...
type NullableImageUrlIn struct {
	value *ImageUrlIn
	isSet bool
}

func (v NullableImageUrlIn) Get() *ImageUrlIn {
	return v.value
}

func (v *NullableImageUrlIn) Set(val *ImageUrlIn) {
	v.value = val
	v.isSet = true
}

func (v NullableImageUrlIn) IsSet() bool {
	return v.isSet
}

func (v *NullableImageUrlIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageUrlIn(val *ImageUrlIn) *NullableImageUrlIn {
	return &NullableImageUrlIn{value: val, isSet: true}
}

func (v NullableImageUrlIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageUrlIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
