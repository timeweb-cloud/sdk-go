...
// checks if the CreateDb type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDb{}

// CreateDb struct for CreateDb
...
func (o CreateDb) MarshalJSON() ([]byte, error) {
...
func (o CreateDb) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDb struct {
	value *CreateDb
	isSet bool
}

func (v NullableCreateDb) Get() *CreateDb {
	return v.value
}

func (v *NullableCreateDb) Set(val *CreateDb) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDb) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDb) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDb(val *CreateDb) *NullableCreateDb {
	return &NullableCreateDb{value: val, isSet: true}
}

func (v NullableCreateDb) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDb) UnmarshalJSON(src []byte) error {
	v.isSet = true
