...
// checks if the AvailableNetworksResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailableNetworksResponse{}

// AvailableNetworksResponse struct for AvailableNetworksResponse
...
func NewAvailableNetworksResponse(availableNetworks []AvailableNetwork, meta ComponentsSchemasMeta) *AvailableNetworksResponse {
	this := AvailableNetworksResponse{}
...
func (o AvailableNetworksResponse) MarshalJSON() ([]byte, error) {
...
func (o AvailableNetworksResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAvailableNetworksResponse struct {
	value *AvailableNetworksResponse
	isSet bool
}

func (v NullableAvailableNetworksResponse) Get() *AvailableNetworksResponse {
	return v.value
}

func (v *NullableAvailableNetworksResponse) Set(val *AvailableNetworksResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailableNetworksResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailableNetworksResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailableNetworksResponse(val *AvailableNetworksResponse) *NullableAvailableNetworksResponse {
	return &NullableAvailableNetworksResponse{value: val, isSet: true}
}

func (v NullableAvailableNetworksResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailableNetworksResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
