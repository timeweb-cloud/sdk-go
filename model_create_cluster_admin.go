...
func (o CreateClusterAdmin) MarshalJSON() ([]byte, error) {
...
func (o CreateClusterAdmin) ToMap() (map[string]interface{}, error) {
...
type NullableCreateClusterAdmin struct {
	value *CreateClusterAdmin
	isSet bool
}

func (v NullableCreateClusterAdmin) Get() *CreateClusterAdmin {
	return v.value
}

func (v *NullableCreateClusterAdmin) Set(val *CreateClusterAdmin) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateClusterAdmin) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateClusterAdmin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateClusterAdmin(val *CreateClusterAdmin) *NullableCreateClusterAdmin {
	return &NullableCreateClusterAdmin{value: val, isSet: true}
}

func (v NullableCreateClusterAdmin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateClusterAdmin) UnmarshalJSON(src []byte) error {
	v.isSet = true
