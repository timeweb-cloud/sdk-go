...
// checks if the ImagesOutResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImagesOutResponse{}
...
func (o ImagesOutResponse) MarshalJSON() ([]byte, error) {
...
func (o ImagesOutResponse) ToMap() (map[string]interface{}, error) {
...
type NullableImagesOutResponse struct {
	value *ImagesOutResponse
	isSet bool
}

func (v NullableImagesOutResponse) Get() *ImagesOutResponse {
	return v.value
}

func (v *NullableImagesOutResponse) Set(val *ImagesOutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImagesOutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImagesOutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImagesOutResponse(val *ImagesOutResponse) *NullableImagesOutResponse {
	return &NullableImagesOutResponse{value: val, isSet: true}
}

func (v NullableImagesOutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImagesOutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
