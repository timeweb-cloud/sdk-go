...
// checks if the ServersSoftwareRequirements type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServersSoftwareRequirements{}

// ServersSoftwareRequirements Требования к облачному серверу для установки ПО.
type ServersSoftwareRequirements struct {
...
func NewServersSoftwareRequirements() *ServersSoftwareRequirements {
	this := ServersSoftwareRequirements{}
	return &this
}
...
func (o ServersSoftwareRequirements) MarshalJSON() ([]byte, error) {
...
func (o ServersSoftwareRequirements) ToMap() (map[string]interface{}, error) {
...
type NullableServersSoftwareRequirements struct {
	value *ServersSoftwareRequirements
	isSet bool
}

func (v NullableServersSoftwareRequirements) Get() *ServersSoftwareRequirements {
	return v.value
}

func (v *NullableServersSoftwareRequirements) Set(val *ServersSoftwareRequirements) {
	v.value = val
	v.isSet = true
}

func (v NullableServersSoftwareRequirements) IsSet() bool {
	return v.isSet
}

func (v *NullableServersSoftwareRequirements) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServersSoftwareRequirements(val *ServersSoftwareRequirements) *NullableServersSoftwareRequirements {
	return &NullableServersSoftwareRequirements{value: val, isSet: true}
}

func (v NullableServersSoftwareRequirements) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServersSoftwareRequirements) UnmarshalJSON(src []byte) error {
	v.isSet = true
