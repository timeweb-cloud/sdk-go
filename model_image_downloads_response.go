...
// checks if the ImageDownloadsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ImageDownloadsResponse{}
...
func (o ImageDownloadsResponse) MarshalJSON() ([]byte, error) {
...
func (o ImageDownloadsResponse) ToMap() (map[string]interface{}, error) {
...
type NullableImageDownloadsResponse struct {
	value *ImageDownloadsResponse
	isSet bool
}

func (v NullableImageDownloadsResponse) Get() *ImageDownloadsResponse {
	return v.value
}

func (v *NullableImageDownloadsResponse) Set(val *ImageDownloadsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableImageDownloadsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableImageDownloadsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableImageDownloadsResponse(val *ImageDownloadsResponse) *NullableImageDownloadsResponse {
	return &NullableImageDownloadsResponse{value: val, isSet: true}
}

func (v NullableImageDownloadsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableImageDownloadsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
