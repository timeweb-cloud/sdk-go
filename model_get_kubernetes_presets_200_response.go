...
// checks if the GetKubernetesPresets200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetKubernetesPresets200Response{}

// GetKubernetesPresets200Response struct for GetKubernetesPresets200Response
type GetKubernetesPresets200Response struct {
...
func NewGetKubernetesPresets200Response(responseId string, meta Meta, k8sPresets []K8SPresetsInner) *GetKubernetesPresets200Response {
	this := GetKubernetesPresets200Response{}
...
func (o GetKubernetesPresets200Response) MarshalJSON() ([]byte, error) {
...
func (o GetKubernetesPresets200Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["response_id"] = o.ResponseId
	toSerialize["meta"] = o.Meta
	toSerialize["k8s_presets"] = o.K8sPresets
	return toSerialize, nil
}

type NullableGetKubernetesPresets200Response struct {
	value *GetKubernetesPresets200Response
	isSet bool
}

func (v NullableGetKubernetesPresets200Response) Get() *GetKubernetesPresets200Response {
	return v.value
}

func (v *NullableGetKubernetesPresets200Response) Set(val *GetKubernetesPresets200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetKubernetesPresets200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetKubernetesPresets200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetKubernetesPresets200Response(val *GetKubernetesPresets200Response) *NullableGetKubernetesPresets200Response {
	return &NullableGetKubernetesPresets200Response{value: val, isSet: true}
}

func (v NullableGetKubernetesPresets200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetKubernetesPresets200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
