...
type UpdateDomain struct {
	...
	LinkedIp NullableString `json:"linked_ip,omitempty"`
}
...
// GetLinkedIp returns the LinkedIp field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *UpdateDomain) GetLinkedIp() string {
	if o == nil || IsNil(o.LinkedIp.Get()) {
		var ret string
		return ret
	}
...
// GetLinkedIpOk returns a tuple with the LinkedIp field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLinkedIp gets a reference to the given NullableString and assigns it to the LinkedIp field.
func (o *UpdateDomain) SetLinkedIp(v string) {
	o.LinkedIp.Set(&v)
}
// SetLinkedIpNil sets the value for LinkedIp to be an explicit nil
func (o *UpdateDomain) SetLinkedIpNil() {
	o.LinkedIp.Set(nil)
}
