...
// checks if the UpdateAgentSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateAgentSettings{}

// UpdateAgentSettings Настройки агента
type UpdateAgentSettings struct {
	Model *AgentModelSettings `json:"model,omitempty"`
	// Системный промпт
	SystemPrompt *string `json:"system_prompt,omitempty"`
	// Уточнять ли запрос перед обработкой
	RefineQuery *bool `json:"refine_query,omitempty"`
...
// SetModel gets a reference to the given AgentModelSettings and assigns it to the Model field.
...
// GetRefineQuery returns the RefineQuery field value if set, zero value otherwise.
func (o *UpdateAgentSettings) GetRefineQuery() bool {
	if o == nil || IsNil(o.RefineQuery) {
		var ret bool
		return ret
	}
...
// GetRefineQueryOk returns a tuple with the RefineQuery field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRefineQuery gets a reference to the given bool and assigns it to the RefineQuery field.
...
func (o UpdateAgentSettings) MarshalJSON() ([]byte, error) {
...
func (o UpdateAgentSettings) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateAgentSettings struct {
	value *UpdateAgentSettings
	isSet bool
}

func (v NullableUpdateAgentSettings) Get() *UpdateAgentSettings {
	return v.value
}

func (v *NullableUpdateAgentSettings) Set(val *UpdateAgentSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateAgentSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateAgentSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateAgentSettings(val *UpdateAgentSettings) *NullableUpdateAgentSettings {
	return &NullableUpdateAgentSettings{value: val, isSet: true}
}

func (v NullableUpdateAgentSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateAgentSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
