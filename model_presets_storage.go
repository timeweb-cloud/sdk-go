...
// checks if the PresetsStorage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PresetsStorage{}
...
func (o PresetsStorage) ToMap() (map[string]interface{}, error) {
...
type NullablePresetsStorage struct {
	value *PresetsStorage
	isSet bool
}

func (v NullablePresetsStorage) Get() *PresetsStorage {
	return v.value
}

func (v *NullablePresetsStorage) Set(val *PresetsStorage) {
	v.value = val
	v.isSet = true
}

func (v NullablePresetsStorage) IsSet() bool {
	return v.isSet
}

func (v *NullablePresetsStorage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePresetsStorage(val *PresetsStorage) *NullablePresetsStorage {
	return &NullablePresetsStorage{value: val, isSet: true}
}

func (v NullablePresetsStorage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePresetsStorage) UnmarshalJSON(src []byte) error {
	v.isSet = true
