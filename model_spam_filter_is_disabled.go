...
// checks if the SpamFilterIsDisabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpamFilterIsDisabled{}

// SpamFilterIsDisabled struct for SpamFilterIsDisabled
type SpamFilterIsDisabled struct {
...
func (o SpamFilterIsDisabled) MarshalJSON() ([]byte, error) {
...
func (o SpamFilterIsDisabled) ToMap() (map[string]interface{}, error) {
...
type NullableSpamFilterIsDisabled struct {
	value *SpamFilterIsDisabled
	isSet bool
}

func (v NullableSpamFilterIsDisabled) Get() *SpamFilterIsDisabled {
	return v.value
}

func (v *NullableSpamFilterIsDisabled) Set(val *SpamFilterIsDisabled) {
	v.value = val
	v.isSet = true
}

func (v NullableSpamFilterIsDisabled) IsSet() bool {
	return v.isSet
}

func (v *NullableSpamFilterIsDisabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpamFilterIsDisabled(val *SpamFilterIsDisabled) *NullableSpamFilterIsDisabled {
	return &NullableSpamFilterIsDisabled{value: val, isSet: true}
}

func (v NullableSpamFilterIsDisabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpamFilterIsDisabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
