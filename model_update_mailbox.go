...
// checks if the UpdateMailbox type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateMailbox{}
...
func (o UpdateMailbox) MarshalJSON() ([]byte, error) {
...
type NullableUpdateMailbox struct {
	value *UpdateMailbox
	isSet bool
}

func (v NullableUpdateMailbox) Get() *UpdateMailbox {
	return v.value
}

func (v *NullableUpdateMailbox) Set(val *UpdateMailbox) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateMailbox) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateMailbox) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateMailbox(val *UpdateMailbox) *NullableUpdateMailbox {
	return &NullableUpdateMailbox{value: val, isSet: true}
}

func (v NullableUpdateMailbox) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateMailbox) UnmarshalJSON(src []byte) error {
	v.isSet = true
