...
// checks if the FirewallRuleOutResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirewallRuleOutResponse{}

// FirewallRuleOutResponse struct for FirewallRuleOutResponse
type FirewallRuleOutResponse struct {
...
func (o FirewallRuleOutResponse) MarshalJSON() ([]byte, error) {
...
func (o FirewallRuleOutResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFirewallRuleOutResponse struct {
	value *FirewallRuleOutResponse
	isSet bool
}

func (v NullableFirewallRuleOutResponse) Get() *FirewallRuleOutResponse {
	return v.value
}

func (v *NullableFirewallRuleOutResponse) Set(val *FirewallRuleOutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallRuleOutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallRuleOutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallRuleOutResponse(val *FirewallRuleOutResponse) *NullableFirewallRuleOutResponse {
	return &NullableFirewallRuleOutResponse{value: val, isSet: true}
}

func (v NullableFirewallRuleOutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallRuleOutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
