...
func NewNetworkResponse(routerNetwork NetworkOut) *NetworkResponse {
...
func (o *NetworkResponse) GetResponseId() string {
...
func (o *NetworkResponse) GetResponseIdOk() (*string, bool) {
	if o == nil || IsNil(o.ResponseId) {
		return nil, false
	}
...
func (o *NetworkResponse) HasResponseId() bool {
	if o != nil && !IsNil(o.ResponseId) {
		return true
	}
...
func (o *NetworkResponse) SetResponseId(v string) {
	o.ResponseId = &v
}

// GetRouterNetwork returns the RouterNetwork field value
func (o *NetworkResponse) GetRouterNetwork() NetworkOut {
	if o == nil {
		var ret NetworkOut
		return ret
	}

	return o.RouterNetwork
}

// GetRouterNetworkOk returns a tuple with the RouterNetwork field value
// and a boolean to check if the value has been set.
func (o *NetworkResponse) GetRouterNetworkOk() (*NetworkOut, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RouterNetwork, true
}

// SetRouterNetwork sets field value
func (o *NetworkResponse) SetRouterNetwork(v NetworkOut) {
	o.RouterNetwork = v
}
...
func (o NetworkResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["router_network"] = o.RouterNetwork
