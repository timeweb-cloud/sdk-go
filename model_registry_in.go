...
// checks if the RegistryIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegistryIn{}

// RegistryIn struct for RegistryIn
...
func (o RegistryIn) MarshalJSON() ([]byte, error) {
...
func (o RegistryIn) ToMap() (map[string]interface{}, error) {
...
type NullableRegistryIn struct {
	value *RegistryIn
	isSet bool
}

func (v NullableRegistryIn) Get() *RegistryIn {
	return v.value
}

func (v *NullableRegistryIn) Set(val *RegistryIn) {
	v.value = val
	v.isSet = true
}

func (v NullableRegistryIn) IsSet() bool {
	return v.isSet
}

func (v *NullableRegistryIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegistryIn(val *RegistryIn) *NullableRegistryIn {
	return &NullableRegistryIn{value: val, isSet: true}
}

func (v NullableRegistryIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegistryIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
