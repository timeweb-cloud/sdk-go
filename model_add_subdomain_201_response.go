...
// checks if the AddSubdomain201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddSubdomain201Response{}
...
type NullableAddSubdomain201Response struct {
	value *AddSubdomain201Response
	isSet bool
}

func (v NullableAddSubdomain201Response) Get() *AddSubdomain201Response {
	return v.value
}

func (v *NullableAddSubdomain201Response) Set(val *AddSubdomain201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableAddSubdomain201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableAddSubdomain201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddSubdomain201Response(val *AddSubdomain201Response) *NullableAddSubdomain201Response {
	return &NullableAddSubdomain201Response{value: val, isSet: true}
}

func (v NullableAddSubdomain201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddSubdomain201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
