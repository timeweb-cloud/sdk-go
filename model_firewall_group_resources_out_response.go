...
// checks if the FirewallGroupResourcesOutResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FirewallGroupResourcesOutResponse{}

// FirewallGroupResourcesOutResponse struct for FirewallGroupResourcesOutResponse
type FirewallGroupResourcesOutResponse struct {
	// Идентификатор запроса
	ResponseId *string `json:"response_id,omitempty"`
	Meta Meta `json:"meta"`
	Resources []FirewallGroupResourceOutAPI `json:"resources"`
}
...
func NewFirewallGroupResourcesOutResponse(meta Meta, resources []FirewallGroupResourceOutAPI) *FirewallGroupResourcesOutResponse {
	this := FirewallGroupResourcesOutResponse{}
	this.Meta = meta
...
func (o FirewallGroupResourcesOutResponse) MarshalJSON() ([]byte, error) {
...
func (o FirewallGroupResourcesOutResponse) ToMap() (map[string]interface{}, error) {
...
type NullableFirewallGroupResourcesOutResponse struct {
	value *FirewallGroupResourcesOutResponse
	isSet bool
}

func (v NullableFirewallGroupResourcesOutResponse) Get() *FirewallGroupResourcesOutResponse {
	return v.value
}

func (v *NullableFirewallGroupResourcesOutResponse) Set(val *FirewallGroupResourcesOutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFirewallGroupResourcesOutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFirewallGroupResourcesOutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFirewallGroupResourcesOutResponse(val *FirewallGroupResourcesOutResponse) *NullableFirewallGroupResourcesOutResponse {
	return &NullableFirewallGroupResourcesOutResponse{value: val, isSet: true}
}

func (v NullableFirewallGroupResourcesOutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFirewallGroupResourcesOutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
