...
// checks if the MailboxSpamFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MailboxSpamFilter{}

// MailboxSpamFilter Спам-фильтр
type MailboxSpamFilter struct {
...
func (o MailboxSpamFilter) MarshalJSON() ([]byte, error) {
...
func (o MailboxSpamFilter) ToMap() (map[string]interface{}, error) {
...
type NullableMailboxSpamFilter struct {
	value *MailboxSpamFilter
	isSet bool
}

func (v NullableMailboxSpamFilter) Get() *MailboxSpamFilter {
	return v.value
}

func (v *NullableMailboxSpamFilter) Set(val *MailboxSpamFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableMailboxSpamFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableMailboxSpamFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMailboxSpamFilter(val *MailboxSpamFilter) *NullableMailboxSpamFilter {
	return &NullableMailboxSpamFilter{value: val, isSet: true}
}

func (v NullableMailboxSpamFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMailboxSpamFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
