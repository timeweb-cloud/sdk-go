...
// checks if the DedicatedServerPresetCpu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DedicatedServerPresetCpu{}

// DedicatedServerPresetCpu Объект, содержащий информацию о процессоре выделенного сервера.
type DedicatedServerPresetCpu struct {
...
func (o DedicatedServerPresetCpu) ToMap() (map[string]interface{}, error) {
...
type NullableDedicatedServerPresetCpu struct {
	value *DedicatedServerPresetCpu
	isSet bool
}

func (v NullableDedicatedServerPresetCpu) Get() *DedicatedServerPresetCpu {
	return v.value
}

func (v *NullableDedicatedServerPresetCpu) Set(val *DedicatedServerPresetCpu) {
	v.value = val
	v.isSet = true
}

func (v NullableDedicatedServerPresetCpu) IsSet() bool {
	return v.isSet
}

func (v *NullableDedicatedServerPresetCpu) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDedicatedServerPresetCpu(val *DedicatedServerPresetCpu) *NullableDedicatedServerPresetCpu {
	return &NullableDedicatedServerPresetCpu{value: val, isSet: true}
}

func (v NullableDedicatedServerPresetCpu) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDedicatedServerPresetCpu) UnmarshalJSON(src []byte) error {
	v.isSet = true
