...
// checks if the AvailableStaticRoute type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AvailableStaticRoute{}

// AvailableStaticRoute struct for AvailableStaticRoute
type AvailableStaticRoute struct {
	...
	// Доступные подсети
	Subnets []AvailableStaticRouteSubnetsInner `json:"subnets,omitempty"`
}
...
func (o *AvailableStaticRoute) GetSubnets() []AvailableStaticRouteSubnetsInner {
	if o == nil || IsNil(o.Subnets) {
		var ret []AvailableStaticRouteSubnetsInner
		return ret
	}
	return o.Subnets
}
...
// SetSubnets gets a reference to the given []AvailableStaticRouteSubnetsInner and assigns it to the Subnets field.
func (o *AvailableStaticRoute) SetSubnets(v []AvailableStaticRouteSubnetsInner) {
	o.Subnets = v
}

func (o AvailableStaticRoute) MarshalJSON() ([]byte, error) {
...
func (o AvailableStaticRoute) ToMap() (map[string]interface{}, error) {
...
type NullableAvailableStaticRoute struct {
	value *AvailableStaticRoute
	isSet bool
}

func (v NullableAvailableStaticRoute) Get() *AvailableStaticRoute {
	return v.value
}

func (v *NullableAvailableStaticRoute) Set(val *AvailableStaticRoute) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailableStaticRoute) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailableStaticRoute) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailableStaticRoute(val *AvailableStaticRoute) *NullableAvailableStaticRoute {
	return &NullableAvailableStaticRoute{value: val, isSet: true}
}

func (v NullableAvailableStaticRoute) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailableStaticRoute) UnmarshalJSON(src []byte) error {
	v.isSet = true
