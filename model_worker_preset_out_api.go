...
// checks if the WorkerPresetOutApi type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkerPresetOutApi{}

// WorkerPresetOutApi struct for WorkerPresetOutApi
...
func (o WorkerPresetOutApi) MarshalJSON() ([]byte, error) {
...
func (o WorkerPresetOutApi) ToMap() (map[string]interface{}, error) {
...
type NullableWorkerPresetOutApi struct {
	value *WorkerPresetOutApi
	isSet bool
}

func (v NullableWorkerPresetOutApi) Get() *WorkerPresetOutApi {
	return v.value
}

func (v *NullableWorkerPresetOutApi) Set(val *WorkerPresetOutApi) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkerPresetOutApi) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkerPresetOutApi) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkerPresetOutApi(val *WorkerPresetOutApi) *NullableWorkerPresetOutApi {
	return &NullableWorkerPresetOutApi{value: val, isSet: true}
}

func (v NullableWorkerPresetOutApi) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkerPresetOutApi) UnmarshalJSON(src []byte) error {
	v.isSet = true
