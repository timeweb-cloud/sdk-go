...
// checks if the CreateMultipleDomainMailboxesV2RequestInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateMultipleDomainMailboxesV2RequestInner{}

// CreateMultipleDomainMailboxesV2RequestInner struct for CreateMultipleDomainMailboxesV2RequestInner
type CreateMultipleDomainMailboxesV2RequestInner struct {
...
func NewCreateMultipleDomainMailboxesV2RequestInner(login string, password string) *CreateMultipleDomainMailboxesV2RequestInner {
	this := CreateMultipleDomainMailboxesV2RequestInner{}
	this.Login = login
...
func (o CreateMultipleDomainMailboxesV2RequestInner) MarshalJSON() ([]byte, error) {
...
func (o CreateMultipleDomainMailboxesV2RequestInner) ToMap() (map[string]interface{}, error) {
...
type NullableCreateMultipleDomainMailboxesV2RequestInner struct {
	value *CreateMultipleDomainMailboxesV2RequestInner
	isSet bool
}

func (v NullableCreateMultipleDomainMailboxesV2RequestInner) Get() *CreateMultipleDomainMailboxesV2RequestInner {
	return v.value
}

func (v *NullableCreateMultipleDomainMailboxesV2RequestInner) Set(val *CreateMultipleDomainMailboxesV2RequestInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateMultipleDomainMailboxesV2RequestInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateMultipleDomainMailboxesV2RequestInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateMultipleDomainMailboxesV2RequestInner(val *CreateMultipleDomainMailboxesV2RequestInner) *NullableCreateMultipleDomainMailboxesV2RequestInner {
	return &NullableCreateMultipleDomainMailboxesV2RequestInner{value: val, isSet: true}
}

func (v NullableCreateMultipleDomainMailboxesV2RequestInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateMultipleDomainMailboxesV2RequestInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
