...
// checks if the GetFinances429Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetFinances429Response{}

// GetFinances429Response struct for GetFinances429Response
type GetFinances429Response struct {
	// Короткий идентификатор, соответствующий возвращаемому коду состояния HTTP.
	StatusCode float32 `json:"status_code"`
	Message *GetFinances429ResponseMessage `json:"message,omitempty"`
...
func (o *GetFinances429Response) GetMessage() GetFinances429ResponseMessage {
	if o == nil || IsNil(o.Message) {
		var ret GetFinances429ResponseMessage
		return ret
	}
	return *o.Message
}
...
// SetMessage gets a reference to the given GetFinances429ResponseMessage and assigns it to the Message field.
...
func (o GetFinances429Response) MarshalJSON() ([]byte, error) {
...
func (o GetFinances429Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetFinances429Response struct {
	value *GetFinances429Response
	isSet bool
}

func (v NullableGetFinances429Response) Get() *GetFinances429Response {
	return v.value
}

func (v *NullableGetFinances429Response) Set(val *GetFinances429Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetFinances429Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetFinances429Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetFinances429Response(val *GetFinances429Response) *NullableGetFinances429Response {
	return &NullableGetFinances429Response{value: val, isSet: true}
}

func (v NullableGetFinances429Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetFinances429Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
