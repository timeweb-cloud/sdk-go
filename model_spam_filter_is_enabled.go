...
// checks if the SpamFilterIsEnabled type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SpamFilterIsEnabled{}

// SpamFilterIsEnabled struct for SpamFilterIsEnabled
type SpamFilterIsEnabled struct {
...
func (o SpamFilterIsEnabled) MarshalJSON() ([]byte, error) {
...
func (o SpamFilterIsEnabled) ToMap() (map[string]interface{}, error) {
...
type NullableSpamFilterIsEnabled struct {
	value *SpamFilterIsEnabled
	isSet bool
}

func (v NullableSpamFilterIsEnabled) Get() *SpamFilterIsEnabled {
	return v.value
}

func (v *NullableSpamFilterIsEnabled) Set(val *SpamFilterIsEnabled) {
	v.value = val
	v.isSet = true
}

func (v NullableSpamFilterIsEnabled) IsSet() bool {
	return v.isSet
}

func (v *NullableSpamFilterIsEnabled) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpamFilterIsEnabled(val *SpamFilterIsEnabled) *NullableSpamFilterIsEnabled {
	return &NullableSpamFilterIsEnabled{value: val, isSet: true}
}

func (v NullableSpamFilterIsEnabled) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpamFilterIsEnabled) UnmarshalJSON(src []byte) error {
	v.isSet = true
