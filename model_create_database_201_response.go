...
// checks if the CreateDatabase201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDatabase201Response{}
...
type NullableCreateDatabase201Response struct {
	value *CreateDatabase201Response
	isSet bool
}

func (v NullableCreateDatabase201Response) Get() *CreateDatabase201Response {
	return v.value
}

func (v *NullableCreateDatabase201Response) Set(val *CreateDatabase201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDatabase201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDatabase201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDatabase201Response(val *CreateDatabase201Response) *NullableCreateDatabase201Response {
	return &NullableCreateDatabase201Response{value: val, isSet: true}
}

func (v NullableCreateDatabase201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDatabase201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
