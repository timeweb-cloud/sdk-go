...
// checks if the NotificationSettingChannels type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationSettingChannels{}

// NotificationSettingChannels Каналы отправки уведомления.
type NotificationSettingChannels struct {
	Email NotificationSettingChannel `json:"email"`
	Sms NotificationSettingChannel `json:"sms"`
	Telegram NotificationSettingChannel `json:"telegram"`
}
...
func NewNotificationSettingChannels(email NotificationSettingChannel, sms NotificationSettingChannel, telegram NotificationSettingChannel) *NotificationSettingChannels {
	this := NotificationSettingChannels{}
	this.Email = email
	this.Sms = sms
...
func (o *NotificationSettingChannels) GetEmail() NotificationSettingChannel {
	if o == nil {
		var ret NotificationSettingChannel
		return ret
	}
...
func (o NotificationSettingChannels) MarshalJSON() ([]byte, error) {
...
func (o NotificationSettingChannels) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationSettingChannels struct {
	value *NotificationSettingChannels
	isSet bool
}

func (v NullableNotificationSettingChannels) Get() *NotificationSettingChannels {
	return v.value
}

func (v *NullableNotificationSettingChannels) Set(val *NotificationSettingChannels) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationSettingChannels) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationSettingChannels) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationSettingChannels(val *NotificationSettingChannels) *NullableNotificationSettingChannels {
	return &NullableNotificationSettingChannels{value: val, isSet: true}
}

func (v NullableNotificationSettingChannels) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationSettingChannels) UnmarshalJSON(src []byte) error {
	v.isSet = true
