...
// GetContainerRegistry returns the ContainerRegistry field value
...
// GetContainerRegistryOk returns a tuple with the ContainerRegistry field value
// and a boolean to check if the value has been set.
...
// SetContainerRegistry sets field value
