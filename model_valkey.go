...
// checks if the Valkey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Valkey{}

// Valkey Параметры Valkey (`valkey` | `valkey7` | `valkey8_1` | `valkey9_1`)
type Valkey struct {
...
func (o Valkey) MarshalJSON() ([]byte, error) {
...
func (o Valkey) ToMap() (map[string]interface{}, error) {
...
type NullableValkey struct {
	value *Valkey
	isSet bool
}

func (v NullableValkey) Get() *Valkey {
	return v.value
}

func (v *NullableValkey) Set(val *Valkey) {
	v.value = val
	v.isSet = true
}

func (v NullableValkey) IsSet() bool {
	return v.isSet
}

func (v *NullableValkey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValkey(val *Valkey) *NullableValkey {
	return &NullableValkey{value: val, isSet: true}
}

func (v NullableValkey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValkey) UnmarshalJSON(src []byte) error {
	v.isSet = true
