...
// checks if the RouterPresetsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouterPresetsResponse{}

// RouterPresetsResponse struct for RouterPresetsResponse
...
// GetRouterPresets returns the RouterPresets field value
func (o *RouterPresetsResponse) GetRouterPresets() []RouterPreset {
	if o == nil {
		var ret []RouterPreset
		return ret
	}

	return o.RouterPresets
}

// GetRouterPresetsOk returns a tuple with the RouterPresets field value
// and a boolean to check if the value has been set.
func (o *RouterPresetsResponse) GetRouterPresetsOk() ([]RouterPreset, bool) {
	if o == nil {
		return nil, false
	}
	return o.RouterPresets, true
}

// SetRouterPresets sets field value
...
func (o RouterPresetsResponse) MarshalJSON() ([]byte, error) {
...
func (o RouterPresetsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ResponseId) {
		toSerialize["response_id"] = o.ResponseId
	}
	toSerialize["router_presets"] = o.RouterPresets
	toSerialize["meta"] = o.Meta
	return toSerialize, nil
}

type NullableRouterPresetsResponse struct {
	value *RouterPresetsResponse
	isSet bool
}

func (v NullableRouterPresetsResponse) Get() *RouterPresetsResponse {
	return v.value
}

func (v *NullableRouterPresetsResponse) Set(val *RouterPresetsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRouterPresetsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRouterPresetsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouterPresetsResponse(val *RouterPresetsResponse) *NullableRouterPresetsResponse {
	return &NullableRouterPresetsResponse{value: val, isSet: true}
}

func (v NullableRouterPresetsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouterPresetsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
