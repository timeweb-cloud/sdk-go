...
// checks if the Bonus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Bonus{}

// Bonus Оплата заявки на продление/регистрацию домена бонусом
type Bonus struct {
...
// GetBonusId returns the BonusId field value
...
// GetBonusIdOk returns a tuple with the BonusId field value
// and a boolean to check if the value has been set.
...
// SetBonusId sets field value
func (o *Bonus) SetBonusId(v float32) {
	o.BonusId = v
}

func (o Bonus) MarshalJSON() ([]byte, error) {
