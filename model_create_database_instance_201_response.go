...
// checks if the CreateDatabaseInstance201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDatabaseInstance201Response{}
...
type NullableCreateDatabaseInstance201Response struct {
	value *CreateDatabaseInstance201Response
	isSet bool
}

func (v NullableCreateDatabaseInstance201Response) Get() *CreateDatabaseInstance201Response {
	return v.value
}

func (v *NullableCreateDatabaseInstance201Response) Set(val *CreateDatabaseInstance201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDatabaseInstance201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDatabaseInstance201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDatabaseInstance201Response(val *CreateDatabaseInstance201Response) *NullableCreateDatabaseInstance201Response {
	return &NullableCreateDatabaseInstance201Response{value: val, isSet: true}
}

func (v NullableCreateDatabaseInstance201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDatabaseInstance201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
