...
// checks if the RoutersResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoutersResponse{}

// RoutersResponse struct for RoutersResponse
...
func (o RoutersResponse) MarshalJSON() ([]byte, error) {
...
func (o RoutersResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRoutersResponse struct {
	value *RoutersResponse
	isSet bool
}

func (v NullableRoutersResponse) Get() *RoutersResponse {
	return v.value
}

func (v *NullableRoutersResponse) Set(val *RoutersResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRoutersResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRoutersResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoutersResponse(val *RoutersResponse) *NullableRoutersResponse {
	return &NullableRoutersResponse{value: val, isSet: true}
}

func (v NullableRoutersResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoutersResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
