...
// checks if the CreateBalancer200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateBalancer200Response{}
...
type NullableCreateBalancer200Response struct {
	value *CreateBalancer200Response
	isSet bool
}

func (v NullableCreateBalancer200Response) Get() *CreateBalancer200Response {
	return v.value
}

func (v *NullableCreateBalancer200Response) Set(val *CreateBalancer200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBalancer200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBalancer200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBalancer200Response(val *CreateBalancer200Response) *NullableCreateBalancer200Response {
	return &NullableCreateBalancer200Response{value: val, isSet: true}
}

func (v NullableCreateBalancer200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBalancer200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
