...
// checks if the VpcService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcService{}

// VpcService struct for VpcService
...
func (o VpcService) MarshalJSON() ([]byte, error) {
...
func (o VpcService) ToMap() (map[string]interface{}, error) {
...
type NullableVpcService struct {
	value *VpcService
	isSet bool
}

func (v NullableVpcService) Get() *VpcService {
	return v.value
}

func (v *NullableVpcService) Set(val *VpcService) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcService) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcService(val *VpcService) *NullableVpcService {
	return &NullableVpcService{value: val, isSet: true}
}

func (v NullableVpcService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcService) UnmarshalJSON(src []byte) error {
	v.isSet = true
