...
// checks if the VpcPort type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpcPort{}

// VpcPort struct for VpcPort
type VpcPort struct {
	// ID порта.
	Id string `json:"id"`
	...
	Service VpcPortService `json:"service"`
}
...
func (o VpcPort) MarshalJSON() ([]byte, error) {
...
func (o VpcPort) ToMap() (map[string]interface{}, error) {
...
type NullableVpcPort struct {
	value *VpcPort
	isSet bool
}

func (v NullableVpcPort) Get() *VpcPort {
	return v.value
}

func (v *NullableVpcPort) Set(val *VpcPort) {
	v.value = val
	v.isSet = true
}

func (v NullableVpcPort) IsSet() bool {
	return v.isSet
}

func (v *NullableVpcPort) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVpcPort(val *VpcPort) *NullableVpcPort {
	return &NullableVpcPort{value: val, isSet: true}
}

func (v NullableVpcPort) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVpcPort) UnmarshalJSON(src []byte) error {
	v.isSet = true
