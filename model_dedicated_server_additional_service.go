...
// checks if the DedicatedServerAdditionalService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DedicatedServerAdditionalService{}

// DedicatedServerAdditionalService Дополнительная услуга для выделенного сервера
type DedicatedServerAdditionalService struct {
...
func NewDedicatedServerAdditionalService(id float32, price float32, period string, description string, shortDescription string, name string) *DedicatedServerAdditionalService {
	this := DedicatedServerAdditionalService{}
	this.Id = id
	this.Price = price
	this.Period = period
...
func (o DedicatedServerAdditionalService) MarshalJSON() ([]byte, error) {
...
func (o DedicatedServerAdditionalService) ToMap() (map[string]interface{}, error) {
...
type NullableDedicatedServerAdditionalService struct {
	value *DedicatedServerAdditionalService
	isSet bool
}

func (v NullableDedicatedServerAdditionalService) Get() *DedicatedServerAdditionalService {
	return v.value
}

func (v *NullableDedicatedServerAdditionalService) Set(val *DedicatedServerAdditionalService) {
	v.value = val
	v.isSet = true
}

func (v NullableDedicatedServerAdditionalService) IsSet() bool {
	return v.isSet
}

func (v *NullableDedicatedServerAdditionalService) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDedicatedServerAdditionalService(val *DedicatedServerAdditionalService) *NullableDedicatedServerAdditionalService {
	return &NullableDedicatedServerAdditionalService{value: val, isSet: true}
}

func (v NullableDedicatedServerAdditionalService) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDedicatedServerAdditionalService) UnmarshalJSON(src []byte) error {
	v.isSet = true
