...
// checks if the UpdateKnowledgebase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateKnowledgebase{}
...
func (o UpdateKnowledgebase) MarshalJSON() ([]byte, error) {
...
func (o UpdateKnowledgebase) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateKnowledgebase struct {
	value *UpdateKnowledgebase
	isSet bool
}

func (v NullableUpdateKnowledgebase) Get() *UpdateKnowledgebase {
	return v.value
}

func (v *NullableUpdateKnowledgebase) Set(val *UpdateKnowledgebase) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateKnowledgebase) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateKnowledgebase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateKnowledgebase(val *UpdateKnowledgebase) *NullableUpdateKnowledgebase {
	return &NullableUpdateKnowledgebase{value: val, isSet: true}
}

func (v NullableUpdateKnowledgebase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateKnowledgebase) UnmarshalJSON(src []byte) error {
	v.isSet = true
