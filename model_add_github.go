...
func (o AddGithub) MarshalJSON() ([]byte, error) {
...
func (o AddGithub) ToMap() (map[string]interface{}, error) {
...
type NullableAddGithub struct {
	value *AddGithub
	isSet bool
}

func (v NullableAddGithub) Get() *AddGithub {
	return v.value
}

func (v *NullableAddGithub) Set(val *AddGithub) {
	v.value = val
	v.isSet = true
}

func (v NullableAddGithub) IsSet() bool {
	return v.isSet
}

func (v *NullableAddGithub) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddGithub(val *AddGithub) *NullableAddGithub {
	return &NullableAddGithub{value: val, isSet: true}
}

func (v NullableAddGithub) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddGithub) UnmarshalJSON(src []byte) error {
	v.isSet = true
